...
PERIODIC_PREAMBLE = (
    ...
    "owe, not the last: if you sense you are approaching a completion, "
    "token, or time limit, or you hit an error mid-execution, STOP the "
    "remaining work and output the report IMMEDIATELY while you still can, "
    "rather than pressing on and risking termination before you report.\n\n"
    "When you cannot finish everything, output a report titled "
    "'PARTIAL REPORT' that lists, in this order:\n"
