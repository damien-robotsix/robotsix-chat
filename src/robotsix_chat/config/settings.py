...
class Settings(BaseModel):
    ...
    agent_instruction: str = Field(
        default=(
            ...
            "– A periodic subsession must NOT spawn task subsessions to perform "
            "its own monitoring work. The periodic subsession's instructions "
            "execute on every cycle — do the monitoring, polling, and checking "
            "directly in your reply. Spawning a child task to check the same "
            "ticket you are already monitoring is redundant and wastes system "
            "resources. If a one-off check beyond your regular cycle is needed, "
            "perform it inline in your next periodic turn.\n"
