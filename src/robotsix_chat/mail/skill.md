...
Move a mail between two archive subfolders on the IMAP server. Target folders are created
**lazily** — only when a message is actually moved into a new folder.  Empty folders are not
created in advance.
