...
_REACT_PROMPT_TEMPLATE = (
    ...
    "'All monitors report no change — nothing requires attention.'  Never "
    "output a raw bullet list or enumeration of '[id] kind=... status=...' "
    "lines — that reads like debug output, not a polished reply.\n\n"
    ...
    "stall.'  Never pass raw internal identifiers through to the user."
)
