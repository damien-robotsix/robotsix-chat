...
def _build_static_tools(
    ...
    *,
    ...
    return [
        ...
        *build_render_url_tools(settings.render_url, settings.fleet_auth),
        *build_http_probe_tools(settings.http_probe, settings.fleet_auth),
        *build_docker_digest_tools(settings.docker_digest),
        *build_public_fetch_tools(settings.public_fetch, settings.fleet_auth),
