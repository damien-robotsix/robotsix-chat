...
def build_autonomous_instruction(settings: Settings) -> str:
    ...
    return (
        ...
        "\n"
        "4. EXECUTION — When you receive the OPERATOR APPROVAL RECEIVED "
        "message after approval, immediately begin executing your plan.  "
        "Start with your first step and use your tools to take the action "
        "now — do not describe what you will do, actually do it.  Work "
        "autonomously through all remaining steps without waiting for "
        "further operator input.  If you hit a genuine blocker that you "
        f"cannot resolve, emit {approval_marker} again with an explanation "
        "of the blocker.\n"
        "\n"
        ...
        "- Request human review: emit the approval marker "
        f"({approval_marker}) with a clear summary of what you have tried, "
