...
def build_autonomous_instruction(settings: Settings) -> str:
    ...
    return (
        ...
        "the ticket details and your recommendation to the operator, then "
        "wait for their explicit approval — do not transition the ticket "
        "yourself.  A standing directive from a prior turn for a different "
