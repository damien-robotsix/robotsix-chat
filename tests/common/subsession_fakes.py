...
def make_settings(
    *,
    ...
    paused_monitor_max_reblock_resumes: int = 3,
    paused_monitor_reblock_notify_threshold: int = 2,
    ...
    event_driven_max_silent_timeouts: int = 8,
    ...
    return SimpleNamespace(
        subsessions=SimpleNamespace(
            ...
            delegated_read_model_level=delegated_read_model_level,
            ...
            event_driven_max_silent_timeouts=event_driven_max_silent_timeouts,
            ...
            paused_monitor_max_reblock_resumes=paused_monitor_max_reblock_resumes,
            paused_monitor_reblock_notify_threshold=paused_monitor_reblock_notify_threshold,
