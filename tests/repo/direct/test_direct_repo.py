...
# Shared fixtures/helpers (_prepopulate_installation_token, _settings,
# _mock_github_auth) live in tests/repo/direct/conftest.py.
...
def test_build_direct_repo_tools_returns_eleven_tools() -> None:
    """Verify that enabled direct_repo returns the eleven expected tools."""
...
def test_direct_fix_available_when_enabled() -> None:
    ...
    assert len(tools) == 13  # 11 base + direct_fix + patch_direct_repo_file
