...
# conversation.py — idle_reset_seconds parameter retained for caller
# compatibility; the parameter is accepted but no longer triggers destructive
# history reset (docstring documents this)
