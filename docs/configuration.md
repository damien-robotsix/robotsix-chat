...
| `subsessions.default_model_level`                       | `integer`       | `3`                        | Default model level for spawned subsessions. Keyless tier (Claude SDK) for guaranteed availability — long-lived background trackers survive provider outages.                                                                                                                                                                                                                                                                                                                                                                                                                                       |
