...
| `subsessions.default_model_level`                       | `integer`       | `4`                        | Default model level for spawned subsessions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `autonomous.model_level`                          | `integer` | `4`                           | llmio capability level for autonomous auto-continue turns. Default `4` (claudeSDK-claude-fable-5, keyless).                                                                                                                         |
