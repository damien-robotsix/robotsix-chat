...
| `diagnostics.mill_events_path`        | `string`  | `"/data/robotsix-mill/diagnostic_events.jsonl"` | Deprecated/unused: `read_diagnostic_events` queries the mill API (`GET /diagnostic-events` on `direct_repo.board_api_base_url`). |
