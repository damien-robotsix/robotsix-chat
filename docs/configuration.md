...
| `vision_model`                  | `string`          | `openrouter/openai/gpt-4o-mini`                       | OpenRouter model id used to caption attached images when the active chat model lacks vision support. Empty string means "vision model unconfigured" — the curated no-image-support failure path then applies instead of attempting to caption.                                                                                                                                                                                                                                                                                                                                                            |
