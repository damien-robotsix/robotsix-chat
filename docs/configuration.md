...
| `subsessions.turn_budget.periodic.soft_warn_turns`      | `integer`       | `25`                       | Same as `task.soft_warn_turns` for `periodic` and `wait_for_event` subsessions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `subsessions.turn_budget.periodic.hard_stop_turns`      | `integer`       | `40`                       | Same as `task.hard_stop_turns` for `periodic` and `wait_for_event` subsessions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
