...
| `compaction_min_turns`  | `integer`       | `3`              | Minimum conversation turns before compaction triggers.                                             |
