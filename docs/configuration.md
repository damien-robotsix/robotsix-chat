...
>>>>>>> 15dd8a1 (mill: subsessions.user_chat_max_retries missing from ### Subsessions table in docs/configuration.md — sibling-pattern doc gap (20260801T052237Z-subsessions-user-chat-max-retries-missin-256f))
