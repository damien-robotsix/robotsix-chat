...
| `/data/subsessions.json`         | Subsession state (periodic subsessions resumed on startup; retry counts for user_chat/task subsessions persisted so retry budget survives restarts) |
