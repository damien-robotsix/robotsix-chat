...
- **Python 3.14+**
- **Claude CLI** (for model level 3, the default) — [install guide](https://docs.anthropic.com/en/docs/claude-code/overview)
...
1. **Install** the package:
    ...
    Available extras: `claude-sdk` (default level 3 transport), `openrouter` (levels 1–2), `memory` (cognee persistence), `broker` (mill integration).
