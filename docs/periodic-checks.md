...
treated as queue wait. It escalates only when the queue ahead of the ticket is empty or idle and
the ticket has still made no progress after the tolerance window.
