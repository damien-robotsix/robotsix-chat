...
- Removed broker-related subsystem documentation from `docs/configuration.md` (Mill, Calendar, Component Agent, Skills) and updated Component Client description to reflect direct HTTP transport.
