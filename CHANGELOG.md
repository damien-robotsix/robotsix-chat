...
## [0.21.0](https://github.com/damien-robotsix/robotsix-chat/compare/v0.20.0...v0.21.0) (2026-09-05)


### ⚠ BREAKING CHANGES

* remove cognee — the robotsix-memory component is the memory backend ([#1857](https://github.com/damien-robotsix/robotsix-chat/issues/1857))
* config `autonomous.*` and /autonomous/* routes removed; deploy migration required (see PR body).
* config keys llmio_cooldown_seconds removed and levels renumbered {1→1, 2→1, 3→2, 4→2, 5→3} — prod config migration required.

### Features

* Add pagination to GET /notifications/unread endpoint (20260902T205536Z-add-pagination-to-get-notifications-unre-c909) ([#1832](https://github.com/damien-robotsix/robotsix-chat/issues/1832)) ([890b94a](https://github.com/damien-robotsix/robotsix-chat/commit/890b94a113b8a76959c08087d723bc3c7f54d65d))
* Add unread badge and missed-notification panel to chat UI (20260902T050056Z-add-unread-badge-and-missed-notification-48be) ([#1837](https://github.com/damien-robotsix/robotsix-chat/issues/1837)) ([553586e](https://github.com/damien-robotsix/robotsix-chat/commit/553586e36d91dd59852a01eca46f9129f8159692))
* Add VACUUM/incremental_vacuum maintenance for cognee_db after pruning (20260902T044751Z-add-vacuum-incremental-vacuum-maintenanc-2657) ([#1815](https://github.com/damien-robotsix/robotsix-chat/issues/1815)) ([a5df526](https://github.com/damien-robotsix/robotsix-chat/commit/a5df526611e3c659515b61d8bf593dc01cacaf42))
* adopt llmio provider failover — 3 capability levels, failover badge, no level fallback ([#1762](https://github.com/damien-robotsix/robotsix-chat/issues/1762)) ([74ed52f](https://github.com/damien-robotsix/robotsix-chat/commit/74ed52fb088c76a54ece83607d741241081351da))
* chat-only fallback workhorse override — level 2 on deepseek-pro ([#1767](https://github.com/damien-robotsix/robotsix-chat/issues/1767)) ([4d3af2d](https://github.com/damien-robotsix/robotsix-chat/commit/4d3af2d73611481b7e47c6506a99eed75e6a1ba4))
* **compaction:** deterministic summary gate — 30 min pass + &gt;5 fresh runs, last 5 runs kept verbatim ([#1779](https://github.com/damien-robotsix/robotsix-chat/issues/1779)) ([5cd3c6a](https://github.com/damien-robotsix/robotsix-chat/commit/5cd3c6a72a4fe4aca338cc57c883297228a5aa87))
* Emit desktop notifications from the existing SSE update stream (20260903T224227Z-emit-desktop-notifications-from-the-exis-4e2b) ([#1860](https://github.com/damien-robotsix/robotsix-chat/issues/1860)) ([2bcc393](https://github.com/damien-robotsix/robotsix-chat/commit/2bcc393a1bb01b89c9489fb8e4b8b439d5fbd3f4))
* Enhance periodic prompt to verify deployed features work before closing tracking (20260901T205418Z-enhance-periodic-prompt-to-verify-deploy-6b74) ([#1794](https://github.com/damien-robotsix/robotsix-chat/issues/1794)) ([3d092f8](https://github.com/damien-robotsix/robotsix-chat/commit/3d092f84a30444ada6eb37df698ecfb569d540a0))
* Group all LLM I/O settings under a dedicated settings group (not "General") (20260904T140437Z-group-all-llm-i-o-settings-under-a-dedic-92eb) ([#1873](https://github.com/damien-robotsix/robotsix-chat/issues/1873)) ([834c29a](https://github.com/damien-robotsix/robotsix-chat/commit/834c29a17989539f50e364b4fd625bac22a465bd))
* implement image captioning client using the already-landed vision_model setting (20260902T104247Z-feat-implement-image-captioning-client-u-eb2f) ([#1807](https://github.com/damien-robotsix/robotsix-chat/issues/1807)) ([e4b2107](https://github.com/damien-robotsix/robotsix-chat/commit/e4b210748000a1134dffe303340ea0c2fa627228))
* Inject reliable current date/time into agent context to prevent date-relative false alarms (20260901T102154Z-inject-reliable-current-date-time-into-a-412a) ([#1800](https://github.com/damien-robotsix/robotsix-chat/issues/1800)) ([c696176](https://github.com/damien-robotsix/robotsix-chat/commit/c6961766c351dad8fb4ee359ced49fa0206ea73f))
* llmio tier overrides as an operator setting (+ /models shows the effective config) ([#1768](https://github.com/damien-robotsix/robotsix-chat/issues/1768)) ([ed1d705](https://github.com/damien-robotsix/robotsix-chat/commit/ed1d7057eee53eb14a5e550e54afbb2ef60f9629))
* periodic sessions replace autonomous sessions; chat approves mill tickets ([#1770](https://github.com/damien-robotsix/robotsix-chat/issues/1770)) ([87819b5](https://github.com/damien-robotsix/robotsix-chat/commit/87819b58562ef11a148e37d11f978f7324d843a4))
* push conversation summaries to the robotsix-memory component ([#1855](https://github.com/damien-robotsix/robotsix-chat/issues/1855)) ([361d7f8](https://github.com/damien-robotsix/robotsix-chat/commit/361d7f868943c01dd777e45cd630b799b28f5297))
* remove cognee — the robotsix-memory component is the memory backend ([#1857](https://github.com/damien-robotsix/robotsix-chat/issues/1857)) ([270bb75](https://github.com/damien-robotsix/robotsix-chat/commit/270bb75321b71f6dbbceeb8e798a69f154c08d25))
* Replay undelivered notifications on SSE client connect (20260902T050056Z-replay-undelivered-notifications-on-sse-112f) ([#1830](https://github.com/damien-robotsix/robotsix-chat/issues/1830)) ([5d1eb0f](https://github.com/damien-robotsix/robotsix-chat/commit/5d1eb0ffd47dd4c6dcfec6c5f538286bc9220eaf))
* route image attachments through llmio's ask_image seam ([#1765](https://github.com/damien-robotsix/robotsix-chat/issues/1765)) ([1b67f49](https://github.com/damien-robotsix/robotsix-chat/commit/1b67f49dd69eb0ef9f13d0820cdd1e8edebe5684))


### Bug Fixes

* accept primitive query-param values in component_request ([#1851](https://github.com/damien-robotsix/robotsix-chat/issues/1851)) ([ffd6318](https://github.com/damien-robotsix/robotsix-chat/commit/ffd63187b31fa0fd2007170b0bca4ff14492c83a))
* Add error handling and resilience for notification storage failures (20260902T205536Z-add-error-handling-and-resilience-for-no-dd67) ([#1838](https://github.com/damien-robotsix/robotsix-chat/issues/1838)) ([460aa6f](https://github.com/damien-robotsix/robotsix-chat/commit/460aa6f0ab82818c13398ba655ee0ef1b70bcf1d))
* Add persistent notification store with bounded retention in chat-data (20260902T050054Z-add-persistent-notification-store-with-b-8979) ([#1806](https://github.com/damien-robotsix/robotsix-chat/issues/1806)) ([40abb10](https://github.com/damien-robotsix/robotsix-chat/commit/40abb10eb095125fab9ce31a95a66ef0a17d4d6f))
* Auto-recover ladybug WAL corruption at boot + close the graph store cleanly on shutdown (2nd recurrence) (20260901T141835Z-auto-recover-ladybug-wal-corruption-at-b-f3c8) ([#1772](https://github.com/damien-robotsix/robotsix-chat/issues/1772)) ([aadf2f8](https://github.com/damien-robotsix/robotsix-chat/commit/aadf2f867989ec5430ee081da4021efc53d4f47c))
* Boot-time reconcile of stale agent_instruction config pins (prod ran a pre-July prompt for 6+ weeks) (20260905T074106Z-boot-time-reconcile-of-stale-agent-instr-43ab) ([#1887](https://github.com/damien-robotsix/robotsix-chat/issues/1887)) ([51bd845](https://github.com/damien-robotsix/robotsix-chat/commit/51bd84502f1cec5d1ae2e56aef62d5324ae9068a))
* Bound cognee cognify memory so session-memory ingestion cannot OOM the chat container (20260903T125736Z-bound-cognee-cognify-memory-so-session-m-6952) ([#1850](https://github.com/damien-robotsix/robotsix-chat/issues/1850)) ([8dd4a82](https://github.com/damien-robotsix/robotsix-chat/commit/8dd4a82c66cc3612f557fad54f039170accd50e7))
* Chat UI still shows advanced-settings toggle — bump @robotsix/ui to the ConfigPanel release that removed it (20260904T084825Z-chat-ui-still-shows-advanced-settings-to-3bc3) ([#1868](https://github.com/damien-robotsix/robotsix-chat/issues/1868)) ([5b5893f](https://github.com/damien-robotsix/robotsix-chat/commit/5b5893faabeee575917f4a35e3c902a2b28d6462))
* CI-fix: uv required-version pin in pyproject.toml must be mirrored by uv-version inputs in shared workflow calls (robotsix-chat) (20260903T235920Z-ci-fix-uv-required-version-pin-in-pyproj-b3a8) ([#1862](https://github.com/damien-robotsix/robotsix-chat/issues/1862)) ([6226cdc](https://github.com/damien-robotsix/robotsix-chat/commit/6226cdc04e3468c7b7b9d3a5b32b066e6e250c39))
* **ci:** pin dependabot-auto-merge to the workflow_call revision ([#1775](https://github.com/damien-robotsix/robotsix-chat/issues/1775)) ([5dd9587](https://github.com/damien-robotsix/robotsix-chat/commit/5dd958799e5d402b28aa702b1ea7bd367937aace))
* Curate no-image-support errors in routes/errors.py (20260901T141142Z-curate-no-image-support-errors-in-routes-ab01) ([#1798](https://github.com/damien-robotsix/robotsix-chat/issues/1798)) ([e54d860](https://github.com/damien-robotsix/robotsix-chat/commit/e54d860c69ae0809817561f6a43e422a73c0fd37))
* **deps:** bump pypdf 6.15.0 → 6.16.1 (GHSA-763m-79hh-57f2 + 2 advisories) ([#1792](https://github.com/damien-robotsix/robotsix-chat/issues/1792)) ([130ab3c](https://github.com/damien-robotsix/robotsix-chat/commit/130ab3c05cea2fe5369854b11b436dd809ca7b1c))
* **deps:** bump robotsix-llmio to 453bad94 (system-prompt argv-limit fix) ([#1883](https://github.com/damien-robotsix/robotsix-chat/issues/1883)) ([e0c3415](https://github.com/damien-robotsix/robotsix-chat/commit/e0c3415d013699610a7f39a51e3e071712fe3bcd))
* **deps:** bump robotsix-llmio to 61ca95d for SDK tool-naming note ([#1789](https://github.com/damien-robotsix/robotsix-chat/issues/1789)) ([b8913d0](https://github.com/damien-robotsix/robotsix-chat/commit/b8913d0e06cd02d12af1b1deaa93f4859b98f0c8))
* **deps:** bump robotsix-llmio to 70c6ae9 — exact claudeSDK tool-name roster ([#1804](https://github.com/damien-robotsix/robotsix-chat/issues/1804)) ([a52d784](https://github.com/damien-robotsix/robotsix-chat/commit/a52d78446c612aca812291cd13e86138bccfde13))
* **feedback:** read mill /repos entries by repo_id — cross-repo tickets were always dropped ([#1791](https://github.com/damien-robotsix/robotsix-chat/issues/1791)) ([ce22410](https://github.com/damien-robotsix/robotsix-chat/commit/ce224102962fa9b79269599c7f40e198301187f2))
* fetch_roster_sync survives a running event loop ([#1773](https://github.com/damien-robotsix/robotsix-chat/issues/1773)) ([4b361f8](https://github.com/damien-robotsix/robotsix-chat/commit/4b361f883108b647c9e9a209aaca0a49b55f7e9c))
* hint at json_body when a bodyless write gets a 422 ([#1852](https://github.com/damien-robotsix/robotsix-chat/issues/1852)) ([f6a0ec3](https://github.com/damien-robotsix/robotsix-chat/commit/f6a0ec344697676dee57aaa0d7ec60556186a66b))
* install the openrouter extra in the image — openai was only ever transitive via cognee ([#1866](https://github.com/damien-robotsix/robotsix-chat/issues/1866)) ([f0ed817](https://github.com/damien-robotsix/robotsix-chat/commit/f0ed8174516831d4aaf88674068bdbde7614328a))
* Instruct code_review agent to consult AGENT.md PEP 758 / Python &gt;=3.14 conventions before raising syntax hard blockers (20260904T111204Z-instruct-code-review-agent-to-consult-ag-4d2c) ([#1874](https://github.com/damien-robotsix/robotsix-chat/issues/1874)) ([ed304ce](https://github.com/damien-robotsix/robotsix-chat/commit/ed304ce513d7d84ab3fb1abfca4242fc990f54e1))
* **lifecycle:** pass the deploy URL to the self-restart client ([#1784](https://github.com/damien-robotsix/robotsix-chat/issues/1784)) ([ed1186b](https://github.com/damien-robotsix/robotsix-chat/commit/ed1186b2b2cb4261f02587b3aabc5da70786bb77))
* **memory:** extract text payload from cognee chunk dicts in recall ([#1786](https://github.com/damien-robotsix/robotsix-chat/issues/1786)) ([4f87cc3](https://github.com/damien-robotsix/robotsix-chat/commit/4f87cc392d6b0c54ce7a8b7b671b5ec71072dfaf))
* name the exception type when the component-roster fetch fails ([#1867](https://github.com/damien-robotsix/robotsix-chat/issues/1867)) ([7fa952d](https://github.com/damien-robotsix/robotsix-chat/commit/7fa952dc4cba2703f2765c245bfc0d314ac65996))
* **periodic:** let operator replies supersede the scheduled task's constraints ([#1787](https://github.com/damien-robotsix/robotsix-chat/issues/1787)) ([247ea10](https://github.com/damien-robotsix/robotsix-chat/commit/247ea1046b0a1bb969672e49a7a1c55f37bebdd0))
* **periodic:** recall memory on the preset task, not the preamble ([#1782](https://github.com/damien-robotsix/robotsix-chat/issues/1782)) ([2399a7b](https://github.com/damien-robotsix/robotsix-chat/commit/2399a7b3952e890b72da07c80aa1f29036da9d8d))
* **prompt:** ship the reply-style directive inside the package ([#1783](https://github.com/damien-robotsix/robotsix-chat/issues/1783)) ([98f2048](https://github.com/damien-robotsix/robotsix-chat/commit/98f2048a5fc547ab9833a0ef7112bd3c861ec150))
* raise per-run request cap to 200 on keyed (OpenRouter) tiers ([#1760](https://github.com/damien-robotsix/robotsix-chat/issues/1760)) ([6ecc6ce](https://github.com/damien-robotsix/robotsix-chat/commit/6ecc6cec8a1ffaf1e2fb49b0cdf49d9b713be021))
* resolve 'robotsix-' prefix aliases in component_request component_id ([#1890](https://github.com/damien-robotsix/robotsix-chat/issues/1890)) ([a18d63d](https://github.com/damien-robotsix/robotsix-chat/commit/a18d63d57da11f82a1030e72ab5cb1e19f898e98))
* Run cognee alembic migrations at memory setup so dependency bumps cannot brick recall (schema drift crashed all recall today) (20260902T114414Z-run-cognee-alembic-migrations-at-memory-4ff9) ([#1817](https://github.com/damien-robotsix/robotsix-chat/issues/1817)) ([3409743](https://github.com/damien-robotsix/robotsix-chat/commit/3409743b853bedcb48d90e9ebb0900d8a34cfd9c))
* Session switch away and back hides the in-flight round (user input + live progress) until it completes (20260901T102252Z-session-switch-away-and-back-hides-the-i-fc72) ([#1802](https://github.com/damien-robotsix/robotsix-chat/issues/1802)) ([c819532](https://github.com/damien-robotsix/robotsix-chat/commit/c8195320abd9db96e3c85ed61db8abdd8532ab5e))
* **startup:** stop false component-health warnings on every boot ([#1790](https://github.com/damien-robotsix/robotsix-chat/issues/1790)) ([cfc9727](https://github.com/damien-robotsix/robotsix-chat/commit/cfc97271b1e1953c6f6e6c52d7d5170aabfb8cbd))
* **subsessions:** bound concurrent monitor agent turns (OOM guard) ([#1808](https://github.com/damien-robotsix/robotsix-chat/issues/1808)) ([10ea702](https://github.com/damien-robotsix/robotsix-chat/commit/10ea702dd256f308164252435016fc1415badc04))
* summary pushes use the memory component's background retain ([#1861](https://github.com/damien-robotsix/robotsix-chat/issues/1861)) ([7fe69f5](https://github.com/damien-robotsix/robotsix-chat/commit/7fe69f5cbd8f0e9b523e8c9dcca61a041a334aa3))
* Support long-running task subsessions: per-spawn run-timeout override; never blind-retry a timed-out turn (20260904T162456Z-support-long-running-task-subsessions-pe-893e) ([#1876](https://github.com/damien-robotsix/robotsix-chat/issues/1876)) ([66d2e2c](https://github.com/damien-robotsix/robotsix-chat/commit/66d2e2c680c6de0a2d2fffe290d0b9cf5315a796))
* **ticket_poll:** resolve tickets against mill's 'id' field ([#1780](https://github.com/damien-robotsix/robotsix-chat/issues/1780)) ([61e5a47](https://github.com/damien-robotsix/robotsix-chat/commit/61e5a479c2200ed1ecdb717e0f446f213cc31f2b))
* **tools:** accept the param aliases agents actually guess on repo tools ([#1884](https://github.com/damien-robotsix/robotsix-chat/issues/1884)) ([67afaab](https://github.com/damien-robotsix/robotsix-chat/commit/67afaab9d1d7af85843bf387606805624c6cf467))
* **tools:** degrade image tool results to text on text-only models ([#1781](https://github.com/damien-robotsix/robotsix-chat/issues/1781)) ([a2e28a3](https://github.com/damien-robotsix/robotsix-chat/commit/a2e28a356cec0c10c5b72dc4bb2ceaa2ffa9b44f))
* **ui:** session model badge resolves llmio tier overrides ([#1785](https://github.com/damien-robotsix/robotsix-chat/issues/1785)) ([14eb80f](https://github.com/damien-robotsix/robotsix-chat/commit/14eb80fe2ba79efcab1eb85549ac374eacc3b860))


### Documentation

* Add user documentation for desktop notifications (20260904T023456Z-add-user-documentation-for-desktop-notif-d5eb) ([#1865](https://github.com/damien-robotsix/robotsix-chat/issues/1865)) ([6e99f4f](https://github.com/damien-robotsix/robotsix-chat/commit/6e99f4f7c957c1b86efb8910cfc30ce04f82bf34))
* Document settings changes: release notes and migration guide for users (20260905T163105Z-document-settings-changes-release-notes-8d78) ([#1894](https://github.com/damien-robotsix/robotsix-chat/issues/1894)) ([3584427](https://github.com/damien-robotsix/robotsix-chat/commit/358442744d5e3c0216fc2fe691df6405918f699c))
* Document vision_model configuration and behavior (20260902T211543Z-document-vision-model-configuration-and-9b4e) ([#1842](https://github.com/damien-robotsix/robotsix-chat/issues/1842)) ([35f5f54](https://github.com/damien-robotsix/robotsix-chat/commit/35f5f54209e8d3d675b1b70be106c544bb9c1a1e))

## [0.20.0](https://github.com/damien-robotsix/robotsix-chat/compare/v0.19.0...v0.20.0) (2026-08-31)


### ⚠ BREAKING CHANGES

* **chat:** one trim mechanism — subject-aware scheduler for all sessions ([#1740](https://github.com/damien-robotsix/robotsix-chat/issues/1740))
* remove the claude_usage scraper (fetch_claude_usage) entirely ([#1729](https://github.com/damien-robotsix/robotsix-chat/issues/1729))

### Features

* Add ability to file tickets for external repos like robotsix-llmio (20260820T215723Z-add-ability-to-file-tickets-for-external-f52a) ([#1549](https://github.com/damien-robotsix/robotsix-chat/issues/1549)) ([0a953a6](https://github.com/damien-robotsix/robotsix-chat/commit/0a953a699a9483f67bfe521e4f440df68427fbea))
* Add chat-agent tools: fetch file from file-hub, fill PDF document, upload filled result back (20260824T223903Z-add-chat-agent-tools-fetch-file-from-fil-ee2e) ([#1625](https://github.com/damien-robotsix/robotsix-chat/issues/1625)) ([00a82b5](https://github.com/damien-robotsix/robotsix-chat/commit/00a82b514d081ddbf34b1c45d06687366baa288d))
* Add cross-session awareness agent tools for the evergoing session (20260829T095021Z-add-cross-session-awareness-agent-tools-266b) ([#1699](https://github.com/damien-robotsix/robotsix-chat/issues/1699)) ([f9ed6ce](https://github.com/damien-robotsix/robotsix-chat/commit/f9ed6ce76ebd22afba31f35bb74d02b20e0037b3))
* Add end-to-end verification step to 'done' state: confirm tool presence in running service before declaring capability ready (20260826T055103Z-add-end-to-end-verification-step-to-done-b18f) ([#1672](https://github.com/damien-robotsix/robotsix-chat/issues/1672)) ([3db4dbb](https://github.com/damien-robotsix/robotsix-chat/commit/3db4dbb60c852af9df92f4f9bb3d2550bb288d9b))
* Add render_pdf_page tool: render a local PDF page to a viewable image so the agent can visually verify overlay placement (20260825T191330Z-add-render-pdf-page-tool-render-a-local-52a4) ([#1632](https://github.com/damien-robotsix/robotsix-chat/issues/1632)) ([566156c](https://github.com/damien-robotsix/robotsix-chat/commit/566156c79df93166b4b2e6b8b0c6b41bb888be13))
* Add self-healing retry for ticket ingestion timeouts (20260827T085400Z-add-self-healing-retry-for-ticket-ingest-5d9b) ([#1682](https://github.com/damien-robotsix/robotsix-chat/issues/1682)) ([030500e](https://github.com/damien-robotsix/robotsix-chat/commit/030500e3d0b33571774520f3b5553d2239db22c3))
* adopt the five-tier llmio level map (haiku as level 2) ([#1696](https://github.com/damien-robotsix/robotsix-chat/issues/1696)) ([97560d9](https://github.com/damien-robotsix/robotsix-chat/commit/97560d908e89fe7180a707f9b1d6b562040ab7de))
* Assistant should automatically detect and surface CI regression on main for merged PRs (20260825T191547Z-assistant-should-automatically-detect-an-ff2d) ([#1636](https://github.com/damien-robotsix/robotsix-chat/issues/1636)) ([a7018af](https://github.com/damien-robotsix/robotsix-chat/commit/a7018afa23cff72b441eb7d7a04798bfcc7d0611))
* Capability: browser-automation component to read Claude Team account remaining-cap value via magic-link login (20260827T125543Z-capability-browser-automation-component-5293) ([#1688](https://github.com/damien-robotsix/robotsix-chat/issues/1688)) ([5be6915](https://github.com/damien-robotsix/robotsix-chat/commit/5be6915e0956dda63e85e23c209219808e439a11))
* **chat:** one trim mechanism — subject-aware scheduler for all sessions ([#1740](https://github.com/damien-robotsix/robotsix-chat/issues/1740)) ([035a24c](https://github.com/damien-robotsix/robotsix-chat/commit/035a24cd0653c31a4168e05acb9838deb812a013))
* **chat:** transparently retry a turn that fails before any token streamed ([#1744](https://github.com/damien-robotsix/robotsix-chat/issues/1744)) ([b1f0485](https://github.com/damien-robotsix/robotsix-chat/commit/b1f0485bbb3dde135a9424d09215c2250583bab4))
* **ci:** add an OpenSSF Scorecard workflow ([#1663](https://github.com/damien-robotsix/robotsix-chat/issues/1663)) ([b445dab](https://github.com/damien-robotsix/robotsix-chat/commit/b445dab8a9b80fb0e38089ac991824c4fe5456fd))
* Clarify when to file a mill configuration bug ticket (20260827T085403Z-clarify-when-to-file-a-mill-configuratio-aea6) ([#1659](https://github.com/damien-robotsix/robotsix-chat/issues/1659)) ([bd53571](https://github.com/damien-robotsix/robotsix-chat/commit/bd53571f48235ce0639bcf27cadbf84fbcfb693c))
* claude_usage: add session-state reuse mode (load operator-captured cookies, scrape usage page directly, skip login) (20260829T205613Z-claude-usage-add-session-state-reuse-mod-a699) ([#1708](https://github.com/damien-robotsix/robotsix-chat/issues/1708)) ([bbd442e](https://github.com/damien-robotsix/robotsix-chat/commit/bbd442e57ae721486d338589f66912e9cae3249a))
* **compaction:** structured, step-aware idle summaries on a dedicated summarizer (level 2) ([#1719](https://github.com/damien-robotsix/robotsix-chat/issues/1719)) ([ffe6afd](https://github.com/damien-robotsix/robotsix-chat/commit/ffe6afd177dd0cfcf9b8e53fe03d7ce1b54ae5fa))
* Enforce conversation-consistency scan on subsession outcomes (20260825T191943Z-enforce-conversation-consistency-scan-on-0617) ([#1671](https://github.com/damien-robotsix/robotsix-chat/issues/1671)) ([c6dc117](https://github.com/damien-robotsix/robotsix-chat/commit/c6dc1177cdd578c9b74070b117dee31c8bae074b))
* Evergoing (never-ending) session with subject-aware auto-trim + cross-session awareness (20260828T153112Z-evergoing-never-ending-session-with-subj-66da) ([#1692](https://github.com/damien-robotsix/robotsix-chat/issues/1692)) ([1b118b7](https://github.com/damien-robotsix/robotsix-chat/commit/1b118b775f9d6690ae1d4032c53cb4cf646b6f7b))
* Fix automatic monitor management after restart (20260827T085359Z-fix-automatic-monitor-management-after-r-515e) ([#1662](https://github.com/damien-robotsix/robotsix-chat/issues/1662)) ([a96732f](https://github.com/damien-robotsix/robotsix-chat/commit/a96732ffd8e9922953ce8f57ba49e184b26664ed))
* Image update may pull pre-merge image — add version pinning (20260825T070547Z-image-update-may-pull-pre-merge-image-ad-b7d6) ([#1629](https://github.com/damien-robotsix/robotsix-chat/issues/1629)) ([a0deb12](https://github.com/damien-robotsix/robotsix-chat/commit/a0deb12944f1564f61085edd11e14b93a591ef35))
* Improve tool readiness check after service restart (20260825T190506Z-improve-tool-readiness-check-after-servi-18c1) ([#1631](https://github.com/damien-robotsix/robotsix-chat/issues/1631)) ([a41ef59](https://github.com/damien-robotsix/robotsix-chat/commit/a41ef59b28c159d7ccb37bdd7c517d8650bcbf6c))
* **llm:** skip the primary Claude probe while its tier is in cooldown ([#1746](https://github.com/damien-robotsix/robotsix-chat/issues/1746)) ([6b08d29](https://github.com/damien-robotsix/robotsix-chat/commit/6b08d2967f69f8eb5f25bbdd4893c043a959bafc))
* Prevent assistant from claiming active monitors that don't exist (20260825T191307Z-prevent-assistant-from-claiming-active-m-9587) ([#1633](https://github.com/damien-robotsix/robotsix-chat/issues/1633)) ([7445648](https://github.com/damien-robotsix/robotsix-chat/commit/74456487cc8de09bf9034e9dff53bdc43d25c926))
* proactive user notification when monitor detects terminal ticket state or blocker (20260830T232152Z-feat-proactive-user-notification-when-mo-84ec) ([#1735](https://github.com/damien-robotsix/robotsix-chat/issues/1735)) ([1e27b5c](https://github.com/damien-robotsix/robotsix-chat/commit/1e27b5c7c4adedcb1c0c7986199dff020353303e))
* Provide CI job logs to the fix agent when it cannot fetch them directly (20260826T091242Z-provide-ci-job-logs-to-the-fix-agent-whe-b749) ([#1643](https://github.com/damien-robotsix/robotsix-chat/issues/1643)) ([a632cf0](https://github.com/damien-robotsix/robotsix-chat/commit/a632cf05a5fbd0b7a6f028b5a46b41c4fa0d4e6f))
* Split oversized mill cleanup ticket into smaller, parallelizable subtickets (20260825T080513Z-split-oversized-mill-cleanup-ticket-into-0237) ([#1630](https://github.com/damien-robotsix/robotsix-chat/issues/1630)) ([b75e09f](https://github.com/damien-robotsix/robotsix-chat/commit/b75e09f021b8f52d811807a9a91df4a8c4ec0299))
* **subsessions:** migrate the turn-retry loop to acall_with_retry (20260821T...-6278) ([#1664](https://github.com/damien-robotsix/robotsix-chat/issues/1664)) ([7d9b6d6](https://github.com/damien-robotsix/robotsix-chat/commit/7d9b6d6fe83997fb0b486a2264272cb7a56bd849))
* Surface Claude quota exhaustion with reset time in chat responses (20260829T220859Z-surface-claude-quota-exhaustion-with-res-8670) ([#1709](https://github.com/damien-robotsix/robotsix-chat/issues/1709)) ([9223879](https://github.com/damien-robotsix/robotsix-chat/commit/9223879396599ff4d1d42e7d1a360467e3525dcf))
* Tier-aware orchestration for costly-tier subsessions (delegate, don't grind) (20260828T103053Z-tier-aware-orchestration-for-costly-tier-8827) ([#1690](https://github.com/damien-robotsix/robotsix-chat/issues/1690)) ([19738a0](https://github.com/damien-robotsix/robotsix-chat/commit/19738a003405ababec29f7f081959bfa14c356f6))
* UI: per-session model selector (20260829T171733Z-ui-per-session-model-selector-6c19) ([#1703](https://github.com/damien-robotsix/robotsix-chat/issues/1703)) ([769ebd5](https://github.com/damien-robotsix/robotsix-chat/commit/769ebd5db50a3ebaec88a950d71d392b8046ef25))
* **ui:** open a compacted session on its summary, with the covered turns behind a toggle ([#1687](https://github.com/damien-robotsix/robotsix-chat/issues/1687)) ([d68e0a2](https://github.com/damien-robotsix/robotsix-chat/commit/d68e0a2f9e6f3ad995b3c43cbf5b8ab15957d3fd))
* Wire up the evergoing session (v2): activation, periodic trim scheduler, UI/cross-session controls (20260829T074717Z-wire-up-the-evergoing-session-v2-activat-ce06) ([#1697](https://github.com/damien-robotsix/robotsix-chat/issues/1697)) ([2f22474](https://github.com/damien-robotsix/robotsix-chat/commit/2f224744888ce34d9399caac17001f5d7cec46e6))


### Bug Fixes

* Add explicit API contract for mail board move/archive/delete endpoints (20260820T221640Z-add-explicit-api-contract-for-mail-board-4856) ([#1669](https://github.com/damien-robotsix/robotsix-chat/issues/1669)) ([dd13cae](https://github.com/damien-robotsix/robotsix-chat/commit/dd13cae0bd7940b5aec88b8f9fb0c6c05150b502))
* Add monitor-status checking before respawning tracking on the same ticket (20260826T072519Z-add-monitor-status-checking-before-respa-a833) ([#1641](https://github.com/damien-robotsix/robotsix-chat/issues/1641)) ([b7710f9](https://github.com/damien-robotsix/robotsix-chat/commit/b7710f93bf9a6f120b5fe2cb4f632d780af69a7e))
* **chat:** a trim that overtakes a legacy compacted summary retires it ([#1748](https://github.com/damien-robotsix/robotsix-chat/issues/1748)) ([4870ca7](https://github.com/damien-robotsix/robotsix-chat/commit/4870ca7719190da5a683392ce478160bf2c23709))
* **chat:** in-flight message visible after session switch; durable queue drain ([#1752](https://github.com/damien-robotsix/robotsix-chat/issues/1752)) ([4a6b9b6](https://github.com/damien-robotsix/robotsix-chat/commit/4a6b9b6fcff91831b7de63f036f55a0867377030))
* **chat:** never idle-compact the evergoing session ([#1739](https://github.com/damien-robotsix/robotsix-chat/issues/1739)) ([b7d662b](https://github.com/damien-robotsix/robotsix-chat/commit/b7d662b62a8d20b6a9a3ef17676f729594642205))
* **chat:** never lose a message — persist failed turns; faster retry; drop dead drain ([#1750](https://github.com/damien-robotsix/robotsix-chat/issues/1750)) ([c715608](https://github.com/damien-robotsix/robotsix-chat/commit/c7156086c6d120dbbf9bd7d3f56403442d4f4900))
* **chat:** the UI transcript keeps trimmed turns — only the agent context shrinks ([#1753](https://github.com/damien-robotsix/robotsix-chat/issues/1753)) ([a34aea1](https://github.com/damien-robotsix/robotsix-chat/commit/a34aea1654f4ee382c413aad5d912a63f83b4dc0))
* **component-access:** accept stringified JSON for json_body/params ([#1725](https://github.com/damien-robotsix/robotsix-chat/issues/1725)) ([43c32bd](https://github.com/damien-robotsix/robotsix-chat/commit/43c32bd1fb9b8a3e788954c8b3d5ca2e0f4a2576))
* Confirm merge queue re-ranking when setting priority (20260824T222754Z-confirm-merge-queue-re-ranking-when-sett-5aae) ([#1624](https://github.com/damien-robotsix/robotsix-chat/issues/1624)) ([66e096e](https://github.com/damien-robotsix/robotsix-chat/commit/66e096e10b638c2bacb94a2eb1f4e0e980be2438))
* Core agent fails to handle ambiguous user commands, breaking autonomous task execution (20260830T130702Z-core-agent-fails-to-handle-ambiguous-use-29b4) ([#1723](https://github.com/damien-robotsix/robotsix-chat/issues/1723)) ([e159af7](https://github.com/damien-robotsix/robotsix-chat/commit/e159af717471a1b6828af0c768e0e59c670bd6aa))
* **deps:** bump llmio + http so render_pdf_page returns a viewable image ([#1673](https://github.com/damien-robotsix/robotsix-chat/issues/1673)) ([a72fe9d](https://github.com/damien-robotsix/robotsix-chat/commit/a72fe9d6f6ef0acb64496838af660ccfa8a9995d))
* **deps:** bump robotsix-llmio so level-2 provider routing applies to mimo ([#1677](https://github.com/damien-robotsix/robotsix-chat/issues/1677)) ([135cd2a](https://github.com/damien-robotsix/robotsix-chat/commit/135cd2a58d11cf07f1c339879f6c1e0de36d28f9))
* **deps:** bump robotsix-llmio so wrapped finish_reason=error is retried ([#1681](https://github.com/damien-robotsix/robotsix-chat/issues/1681)) ([af7a489](https://github.com/damien-robotsix/robotsix-chat/commit/af7a4894174c704b0a00ec2c37825573c315a095))
* **deps:** bump robotsix-llmio to pick up session-limit fallback ([#1660](https://github.com/damien-robotsix/robotsix-chat/issues/1660)) ([0f133ce](https://github.com/damien-robotsix/robotsix-chat/commit/0f133ce0c76bc2ff425c282712f8b19251875927))
* Ensure rework feedback is reliably injected before automated cycles progress (20260825T052257Z-ensure-rework-feedback-is-reliably-injec-5daf) ([#1675](https://github.com/damien-robotsix/robotsix-chat/issues/1675)) ([92b4acb](https://github.com/damien-robotsix/robotsix-chat/commit/92b4acb06148f4087ae672e6c367975d95442e85))
* **errors:** classify a failed fallback turn by its exhaustion root cause ([#1730](https://github.com/damien-robotsix/robotsix-chat/issues/1730)) ([e5bb499](https://github.com/damien-robotsix/robotsix-chat/commit/e5bb499d798513a140e3aa440da281359654fa97))
* **evergoing:** pending work on the same workstream is not a subject change ([#1743](https://github.com/damien-robotsix/robotsix-chat/issues/1743)) ([38e9379](https://github.com/damien-robotsix/robotsix-chat/commit/38e9379f55c7686f1072803d245b5202ac29ec30))
* Extend fill_pdf_document with image overlays (place operator-provided signature image on a PDF) (20260825T210242Z-extend-fill-pdf-document-with-image-over-e6ad) ([#1634](https://github.com/damien-robotsix/robotsix-chat/issues/1634)) ([8e1168d](https://github.com/damien-robotsix/robotsix-chat/commit/8e1168d099e8b0ff770dba2ecb3abdf372a528a1))
* fetch_claude_usage: login submit never triggers the Anthropic email — force Continue/submit + detect Turnstile on the login form (20260829T171202Z-fetch-claude-usage-login-submit-never-tr-2261) ([#1702](https://github.com/damien-robotsix/robotsix-chat/issues/1702)) ([e842477](https://github.com/damien-robotsix/robotsix-chat/commit/e842477fff0a778c2bbdac4dc104a2e00d6c424a))
* Fix infinite redirect loop: pending subsession outcomes not marked consumed after being surfaced (20260827T131016Z-fix-infinite-redirect-loop-pending-subse-082c) ([#1683](https://github.com/damien-robotsix/robotsix-chat/issues/1683)) ([602e51b](https://github.com/damien-robotsix/robotsix-chat/commit/602e51b701d34e2fa553f21d950d4dc5634eb6c2))
* Fix state reporting to never claim 'merged' or 'deployed' without verifying the PR and secret (20260827T061850Z-fix-state-reporting-to-never-claim-merge-6af3) ([#1653](https://github.com/damien-robotsix/robotsix-chat/issues/1653)) ([a0985df](https://github.com/damien-robotsix/robotsix-chat/commit/a0985df878b82a02412b8133be17c2592b4444af))
* Fix Trivy container-scan failure on main blocking Release image (20260826T055556Z-fix-trivy-container-scan-failure-on-main-1b4a) ([#1638](https://github.com/damien-robotsix/robotsix-chat/issues/1638)) ([644029d](https://github.com/damien-robotsix/robotsix-chat/commit/644029d1cbab5a05d54bfe517596f452b1869dab))
* Harden claude_usage login flow against Cloudflare bot challenge (fetch_claude_usage blocked before email step) (20260829T071613Z-harden-claude-usage-login-flow-against-c-7b3b) ([#1698](https://github.com/damien-robotsix/robotsix-chat/issues/1698)) ([c432f64](https://github.com/damien-robotsix/robotsix-chat/commit/c432f64b40a98c7d4097a9316c3d21e708591a80))
* Harden SSRF in robotsix_chat http_fetch: pin the validated IP at the httpcore pool layer and close the http_probe redirect bypass (20260829T012110Z-harden-ssrf-in-robotsix-chat-http-fetch-74ed) ([#1694](https://github.com/damien-robotsix/robotsix-chat/issues/1694)) ([f9656dd](https://github.com/damien-robotsix/robotsix-chat/commit/f9656dd3546597f29b276e73ec9ed0ce2a986b0a))
* Improve monitor ticket-closure detection to avoid false 'closed without PR' warnings (20260829T203509Z-improve-monitor-ticket-closure-detection-bc8a) ([#1706](https://github.com/damien-robotsix/robotsix-chat/issues/1706)) ([1ea78b3](https://github.com/damien-robotsix/robotsix-chat/commit/1ea78b338ab4d61d48d2c15699ca106803911295))
* Include final metadata consolidation in response to user queries about status (20260826T072646Z-include-final-metadata-consolidation-in-6ac6) ([#1642](https://github.com/damien-robotsix/robotsix-chat/issues/1642)) ([ace99ca](https://github.com/damien-robotsix/robotsix-chat/commit/ace99caff8481c399447cbaa74d5f5451cb75126))
* **llm:** keep sync tools sync in require_args; stop the usage fallback at mimo ([#1722](https://github.com/damien-robotsix/robotsix-chat/issues/1722)) ([580d3b4](https://github.com/damien-robotsix/robotsix-chat/commit/580d3b48574581c5b49d27abfa3325c42f8fe131))
* **llm:** make Claude turns stateless — no accumulated history or stale memory blocks ([#1707](https://github.com/damien-robotsix/robotsix-chat/issues/1707)) ([ec53661](https://github.com/damien-robotsix/robotsix-chat/commit/ec53661de770d66a26b91e44765487667afd2019))
* **llm:** trigger the tier fallback on chain-buried Claude unavailability ([#1741](https://github.com/damien-robotsix/robotsix-chat/issues/1741)) ([345d02a](https://github.com/damien-robotsix/robotsix-chat/commit/345d02a8614c71db34458b0d6e095a318c090cfa))
* **llm:** usage-exhausted fallback walks past sibling Claude tiers to the keyed level ([#1710](https://github.com/damien-robotsix/robotsix-chat/issues/1710)) ([9675ac3](https://github.com/damien-robotsix/robotsix-chat/commit/9675ac38f541536aba5d696d3438ad87c0e8cc49))
* Periodic subsessions must report actionable decisions via durable markers and parent-session notifications (20260825T070524Z-periodic-subsessions-must-report-actiona-360f) ([#1680](https://github.com/damien-robotsix/robotsix-chat/issues/1680)) ([4c48e24](https://github.com/damien-robotsix/robotsix-chat/commit/4c48e245c61a9fcb0cd6c6bdcfe1386abf603bf7))
* Prevent auto-fix agents from looping on capability gaps without escalating (20260824T193339Z-prevent-auto-fix-agents-from-looping-on-b4cb) ([#1621](https://github.com/damien-robotsix/robotsix-chat/issues/1621)) ([56f7fe9](https://github.com/damien-robotsix/robotsix-chat/commit/56f7fe92e0694e73544faded3f4ff951a8b84614))
* Prevent monitors from reporting ticket terminal states as failures without checking incremental progress (20260826T055357Z-prevent-monitors-from-reporting-ticket-t-c3c7) ([#1640](https://github.com/damien-robotsix/robotsix-chat/issues/1640)) ([987fd6c](https://github.com/damien-robotsix/robotsix-chat/commit/987fd6c545afa2d11eed983eef5d4abd849fd4df))
* **render_url:** return a viewable image, not base64 inside a JSON string ([#1674](https://github.com/damien-robotsix/robotsix-chat/issues/1674)) ([91c45d0](https://github.com/damien-robotsix/robotsix-chat/commit/91c45d0fba4d555ef7faaaae2175d6c1a32ae754))
* Stabilize tool 'component_request' ingest endpoint to prevent repeated timeouts (20260825T210204Z-stabilize-tool-component-request-ingest-b0c1) ([#1639](https://github.com/damien-robotsix/robotsix-chat/issues/1639)) ([705e232](https://github.com/damien-robotsix/robotsix-chat/commit/705e2329d3b1aef7bf238c4536677243f4fe0928))
* Subsession runtime: make tool-call retry exhaustion non-fatal (component_request 'exceeded max retries' kills the whole subsession) (20260825T041112Z-subsession-runtime-make-tool-call-retry-3105) ([#1627](https://github.com/damien-robotsix/robotsix-chat/issues/1627)) ([e542626](https://github.com/damien-robotsix/robotsix-chat/commit/e542626f1eb7dcd0c0976d428bb6ff51dac37925))
* **subsessions:** let a re-activated ticket be monitored again after a terminal report ([#1686](https://github.com/damien-robotsix/robotsix-chat/issues/1686)) ([2eeca3f](https://github.com/damien-robotsix/robotsix-chat/commit/2eeca3f9c0f03fd50892a9b836ea767cc6d55481))
* **subsessions:** recover a waiting user_chat's question from turn_history on resume ([#1678](https://github.com/damien-robotsix/robotsix-chat/issues/1678)) ([fddbfde](https://github.com/damien-robotsix/robotsix-chat/commit/fddbfde7470971c961bdda27c55fa2f16c02844f))
* **subsessions:** stop re-driving LLM turns on restart resume and quiet safety-net timeouts ([#1676](https://github.com/damien-robotsix/robotsix-chat/issues/1676)) ([9127edb](https://github.com/damien-robotsix/robotsix-chat/commit/9127edb77af39c620c6ed5566cbbf8d0fd1a7c2c))
* surface memory-backend degradation in the chat UI ([#1652](https://github.com/damien-robotsix/robotsix-chat/issues/1652)) ([05c6a3f](https://github.com/damien-robotsix/robotsix-chat/commit/05c6a3f5af429e29f34d8cb0241d6dc51d2730da))
* **ticket-poll:** use the real mill state machine and resolve repos from the mill registry — stop calling delivered tickets "dropped" ([#1717](https://github.com/damien-robotsix/robotsix-chat/issues/1717)) ([cc89614](https://github.com/damien-robotsix/robotsix-chat/commit/cc896148325303752d2297b25c2f73d640a06790))
* upgrade openssl in the runtime image to clear CVE-2026-14456 ([#1651](https://github.com/damien-robotsix/robotsix-chat/issues/1651)) ([7f76616](https://github.com/damien-robotsix/robotsix-chat/commit/7f7661679824d8e8fad6580cb25d87097d8302a9))


### Documentation

* Clarify pipeline stage terminology when reporting status (20260824T222742Z-clarify-pipeline-stage-terminology-when-8956) ([#1623](https://github.com/damien-robotsix/robotsix-chat/issues/1623)) ([e3a2f6c](https://github.com/damien-robotsix/robotsix-chat/commit/e3a2f6c69b42ad62563047cfc72d02b343634bc2))
* Deploy component does not expose a config schema (20260824T222758Z-deploy-component-does-not-expose-a-confi-1274) ([#1626](https://github.com/damien-robotsix/robotsix-chat/issues/1626)) ([f61f426](https://github.com/damien-robotsix/robotsix-chat/commit/f61f4266045211df74f27bd6ea6fe4831e014854))


### Miscellaneous Chores

* remove the claude_usage scraper (fetch_claude_usage) entirely ([#1729](https://github.com/damien-robotsix/robotsix-chat/issues/1729)) ([2070b3b](https://github.com/damien-robotsix/robotsix-chat/commit/2070b3b7ec51badbc3113440f8806029e6b5f1f2))

## [0.19.0](https://github.com/damien-robotsix/robotsix-chat/compare/v0.18.1...v0.19.0) (2026-08-24)
...
* Add post-merge deployment verification to ticket lifecycle (20260823T113350Z-add-post-merge-deployment-verification-t-1f75) ([#1593](https://github.com/damien-robotsix/robotsix-chat/issues/1593)) ([66d6733](https://github.com/damien-robotsix/robotsix-chat/commit/66d673333b287db733b5ffd68fff3600890784e8))
...
* Auto-approve low-risk, well-scoped tickets without user gate (20260822T235436Z-auto-approve-low-risk-well-scoped-ticket-180c) ([#1587](https://github.com/damien-robotsix/robotsix-chat/issues/1587)) ([cc363fa](https://github.com/damien-robotsix/robotsix-chat/commit/cc363fafbb335ee963645f3394536d25c916c211))
...
* Auto-merge denylist and sensitive path logic block progress — escalate to operator early (20260823T150654Z-auto-merge-denylist-and-sensitive-path-l-62eb) ([#1596](https://github.com/damien-robotsix/robotsix-chat/issues/1596)) ([3c88ead](https://github.com/damien-robotsix/robotsix-chat/commit/3c88eade593854126f81aad230d540a70bbf801e))
* Auto-spawn verification monitor when queue-reset monitor fails (20260824T140455Z-auto-spawn-verification-monitor-when-que-98c9) ([#1612](https://github.com/damien-robotsix/robotsix-chat/issues/1612)) ([1faa743](https://github.com/damien-robotsix/robotsix-chat/commit/1faa7432d7e6d708a0377dd2e4904d5bc5d9386a))
...
* Detect and alert on tickets stuck in the implementation queue (20260823T001310Z-detect-and-alert-on-tickets-stuck-in-the-aa21) ([#1590](https://github.com/damien-robotsix/robotsix-chat/issues/1590)) ([3749dc3](https://github.com/damien-robotsix/robotsix-chat/commit/3749dc3f3ba57ce0878a1c8b5acda3f930a65bc0))
...
* Enforce no-revert policy on CI migration tickets via ticket-level constraint tags (20260824T121453Z-enforce-no-revert-policy-on-ci-migration-1fcc) ([#1605](https://github.com/damien-robotsix/robotsix-chat/issues/1605)) ([86cf16e](https://github.com/damien-robotsix/robotsix-chat/commit/86cf16e46af85c6b2e089531a709a6c26ba46e3d))
* File a ticket to close redundant audit-fix ticket after deadlock resolution (20260824T192937Z-file-a-ticket-to-close-redundant-audit-f-3a8d) ([#1620](https://github.com/damien-robotsix/robotsix-chat/issues/1620)) ([24566ab](https://github.com/damien-robotsix/robotsix-chat/commit/24566ab36b948c6dbc312c417e9f2fea380d8af5))
...
* Handle skill body loading failures gracefully with user-visible fallback (20260824T192339Z-handle-skill-body-loading-failures-grace-ac95) ([#1619](https://github.com/damien-robotsix/robotsix-chat/issues/1619)) ([5d700ec](https://github.com/damien-robotsix/robotsix-chat/commit/5d700ec539554404f173b0fd592c6fed60d99d77))
...
* Reject or route misfiled tickets at the gate (20260824T140504Z-reject-or-route-misfiled-tickets-at-the-434f) ([#1613](https://github.com/damien-robotsix/robotsix-chat/issues/1613)) ([7fde8d8](https://github.com/damien-robotsix/robotsix-chat/commit/7fde8d86caef426282260dc634055507a79efbb0))
...
* Simplify response to speed/crash feedback for autonomous agent (20260823T175059Z-simplify-response-to-speed-crash-feedbac-b09d) ([#1600](https://github.com/damien-robotsix/robotsix-chat/issues/1600)) ([ee0aebd](https://github.com/damien-robotsix/robotsix-chat/commit/ee0aebd5ac28efd0fd5ebb385acf2a60e13467c6))
* Standardize verification guidance for AppShell loader integration (20260823T150640Z-standardize-verification-guidance-for-ap-bb08) ([#1595](https://github.com/damien-robotsix/robotsix-chat/issues/1595)) ([e846092](https://github.com/damien-robotsix/robotsix-chat/commit/e846092c7690509bc9aeaec5ffb4368a5180ebdf))
...
* Add monitor lifecycle management for coordinated ticket tracking (20260824T121439Z-add-monitor-lifecycle-management-for-coo-f756) ([#1607](https://github.com/damien-robotsix/robotsix-chat/issues/1607)) ([dbd729d](https://github.com/damien-robotsix/robotsix-chat/commit/dbd729d16910eb559aac9f13cbdeca985b114998))
* Add per-subsession turn/cost budget guard to bound runaway cap burn (20260824T083354Z-add-per-subsession-turn-cost-budget-guar-04ea) ([#1604](https://github.com/damien-robotsix/robotsix-chat/issues/1604)) ([e085ac4](https://github.com/damien-robotsix/robotsix-chat/commit/e085ac448f32cc739de423c5e1e128ba6eb24bd1))
* Auto-advance approved proposals through issue-approval gate without requiring re-approval (20260823T001252Z-auto-advance-approved-proposals-through-54a3) ([#1588](https://github.com/damien-robotsix/robotsix-chat/issues/1588)) ([38dc5fc](https://github.com/damien-robotsix/robotsix-chat/commit/38dc5fc7530ec75dae5447355276ae8fc8431383))
...
* **config:** nest the config document under `config` in every response ([#1615](https://github.com/damien-robotsix/robotsix-chat/issues/1615)) ([a0ff8f6](https://github.com/damien-robotsix/robotsix-chat/commit/a0ff8f6f7df7a40ab10d4d7dbb3abcc5a49ef15e))
* Consolidate monitor outcome messages to avoid repeating already-surfaced decisions (20260823T150700Z-consolidate-monitor-outcome-messages-to-c9e1) ([#1599](https://github.com/damien-robotsix/robotsix-chat/issues/1599)) ([befd305](https://github.com/damien-robotsix/robotsix-chat/commit/befd3052239e46ca6acdd12c61a714bc6d4635fb))
* Consolidate user-facing outcome reports into a single paragraph with clear next steps (20260824T070756Z-consolidate-user-facing-outcome-reports-2147) ([#1602](https://github.com/damien-robotsix/robotsix-chat/issues/1602)) ([5197f3c](https://github.com/damien-robotsix/robotsix-chat/commit/5197f3ce16fc66b8fd49fa1b7b6efae135fac480))
* Consolidation gate fails to enforce fresh state fetch on recheck request (20260823T001242Z-consolidation-gate-fails-to-enforce-fres-89c2) ([#1589](https://github.com/damien-robotsix/robotsix-chat/issues/1589)) ([3f7a727](https://github.com/damien-robotsix/robotsix-chat/commit/3f7a727236c3e8ba810a6039e810bd06586f3680))
...
* Enforce per-batch explicit confirmation for state-mutating operations despite a single user statement (20260824T132830Z-enforce-per-batch-explicit-confirmation-ebe9) ([#1609](https://github.com/damien-robotsix/robotsix-chat/issues/1609)) ([75e920a](https://github.com/damien-robotsix/robotsix-chat/commit/75e920aad6b49011deb36e3100967cb468520c3e))
* file_ticket helper returns empty response on success (20260824T140446Z-file-ticket-helper-returns-empty-respons-d240) ([#1610](https://github.com/damien-robotsix/robotsix-chat/issues/1610)) ([9f877d3](https://github.com/damien-robotsix/robotsix-chat/commit/9f877d3d36c2260bd1f6a3fc3fd5df770001f4e7))
...
* Fix stall monitor false-positive for 'ready' priority tickets with queue latency (20260823T113653Z-fix-stall-monitor-false-positive-for-rea-70f2) ([#1592](https://github.com/damien-robotsix/robotsix-chat/issues/1592)) ([4c7e660](https://github.com/damien-robotsix/robotsix-chat/commit/4c7e6605ce195dfc63348244f675f965c7470757))
* Investigate and fix stale reviewer cache replaying 'request changes' verdict (20260822T235347Z-investigate-and-fix-stale-reviewer-cache-15be) ([#1585](https://github.com/damien-robotsix/robotsix-chat/issues/1585)) ([9b1eec1](https://github.com/damien-robotsix/robotsix-chat/commit/9b1eec1c04de8896c62d3bcb486f2bb889f879f8))
...
* Monitor subsessions fail silently on transient provider errors (20260824T140520Z-monitor-subsessions-fail-silently-on-tra-1cf8) ([#1611](https://github.com/damien-robotsix/robotsix-chat/issues/1611)) ([140ee18](https://github.com/damien-robotsix/robotsix-chat/commit/140ee1801aefa39bfce2fc67644cb7c2090752c9))
...
* Reduce false-positive alerts from periodic subsession monitor (20260822T235429Z-reduce-false-positive-alerts-from-period-3c46) ([#1586](https://github.com/damien-robotsix/robotsix-chat/issues/1586)) ([fd719c3](https://github.com/damien-robotsix/robotsix-chat/commit/fd719c302b76699960bc7b3eff383675bb63a497))
* Remove three dead nav links (Board, File Hub, Central Deploy) from chat header (20260824T181339Z-remove-three-dead-nav-links-board-file-h-4c7f) ([#1617](https://github.com/damien-robotsix/robotsix-chat/issues/1617)) ([b4a6ac5](https://github.com/damien-robotsix/robotsix-chat/commit/b4a6ac50fd18e57781209454a2fdc3e60995f864))
* stop autonomous sessions being replaced mid-conversation ([#1601](https://github.com/damien-robotsix/robotsix-chat/issues/1601)) ([8f1905c](https://github.com/damien-robotsix/robotsix-chat/commit/8f1905c7ea93bac4000b590fdd8cb82d20101114))
* Support autonomous-session presets for periodic tasks (20260824T192328Z-support-autonomous-session-presets-for-p-63c9) ([#1618](https://github.com/damien-robotsix/robotsix-chat/issues/1618)) ([e49d6b2](https://github.com/damien-robotsix/robotsix-chat/commit/e49d6b234290510182b1a75fba6c804fec9b0a95))
...
* Document file_ticket repo_id pre-validation in skill.md (20260824T162432Z-document-file-ticket-repo-id-pre-validat-2002) ([#1614](https://github.com/damien-robotsix/robotsix-chat/issues/1614)) ([bfb5c5a](https://github.com/damien-robotsix/robotsix-chat/commit/bfb5c5ab1c8524e816fc615e16a1a1f07024041f))
...
* Add a 'prioritize all open tickets' command or tool (20260808T185947Z-add-a-prioritize-all-open-tickets-comman-5dc7) ([#1301](https://github.com/damien-robotsix/robotsix-chat/issues/1301)) ([933ce30](https://github.com/damien-robotsix/robotsix-chat/commit/933ce30db786df4648d10b820b610441d698c5f0))
* Add account enumeration tool for mail board (20260809T125609Z-add-account-enumeration-tool-for-mail-bo-7f30) ([#1407](https://github.com/damien-robotsix/robotsix-chat/issues/1407)) ([db1e8fc](https://github.com/damien-robotsix/robotsix-chat/commit/db1e8fc57152a608380e834286bc12b5e786073c))
* Add archive folder browse and move endpoints (20260809T082040Z-add-archive-folder-browse-and-move-endpo-d998) ([#1336](https://github.com/damien-robotsix/robotsix-chat/issues/1336)) ([dd9ed5f](https://github.com/damien-robotsix/robotsix-chat/commit/dd9ed5f80da1e5f63d8ec00666eadce5c5c7b392))
* Add archive folder-delete endpoint with empty-only guard (20260809T104603Z-add-archive-folder-delete-endpoint-with-5629) ([#1351](https://github.com/damien-robotsix/robotsix-chat/issues/1351)) ([c702083](https://github.com/damien-robotsix/robotsix-chat/commit/c7020837dbbd33d37e52440be393a174ecef367f))
* Add archive folder-rename endpoint (20260809T104604Z-add-archive-folder-rename-endpoint-02a1) ([#1352](https://github.com/damien-robotsix/robotsix-chat/issues/1352)) ([cee037c](https://github.com/damien-robotsix/robotsix-chat/commit/cee037c4053b92153c7f6416e221e740296c5325))
* Add autonomous approval capability for routine security-sensitive provisioning tickets (20260808T181237Z-add-autonomous-approval-capability-for-r-afd3) ([#1297](https://github.com/damien-robotsix/robotsix-chat/issues/1297)) ([780d975](https://github.com/damien-robotsix/robotsix-chat/commit/780d97595d4d71b977f90d985215354d83a241be))
* Add chat-facing endpoint to list IMAP folders above the archive root (20260809T214712Z-add-chat-facing-endpoint-to-list-imap-fo-3f3e) ([#1416](https://github.com/damien-robotsix/robotsix-chat/issues/1416)) ([bd4138e](https://github.com/damien-robotsix/robotsix-chat/commit/bd4138ec1f845cb47a46a67cdbd0aef0a2fdcf20))
* Add deploy-gateway routing diagnostic tool (20260809T125014Z-add-deploy-gateway-routing-diagnostic-to-2801) ([#1410](https://github.com/damien-robotsix/robotsix-chat/issues/1410)) ([0687a9c](https://github.com/damien-robotsix/robotsix-chat/commit/0687a9cc634ac7c1e08fe4812e666e0cc8d20738))
* Add diagnostic event inspection tool for the mill subsystem (20260809T064345Z-add-diagnostic-event-inspection-tool-for-b1aa) ([#1312](https://github.com/damien-robotsix/robotsix-chat/issues/1312)) ([e63449e](https://github.com/damien-robotsix/robotsix-chat/commit/e63449edde0d18d1ca55e2551663845e5739742a))
* Add self-escalation for monitors hitting repeated run limits (20260808T192821Z-add-self-escalation-for-monitors-hitting-7847) ([#1300](https://github.com/damien-robotsix/robotsix-chat/issues/1300)) ([8105125](https://github.com/damien-robotsix/robotsix-chat/commit/8105125694c5a98f3b057f0bea863d6619215ecd))
* Add startup connectivity check for rostered components in robotsix-chat (20260808T140506Z-add-startup-connectivity-check-for-roste-2aca) ([#1295](https://github.com/damien-robotsix/robotsix-chat/issues/1295)) ([d957748](https://github.com/damien-robotsix/robotsix-chat/commit/d95774878aece48422674f8070a7fcaf3ebefc05))
* Add structured ticket-to-PR lookup to avoid enumeration failures (20260807T064751Z-add-structured-ticket-to-pr-lookup-to-av-177b) ([#1338](https://github.com/damien-robotsix/robotsix-chat/issues/1338)) ([0532295](https://github.com/damien-robotsix/robotsix-chat/commit/05322954306a56022f1a21b46a81302c0752a598))
* Approval prompts should avoid re-stating full context when user is aware (20260807T230222Z-approval-prompts-should-avoid-re-stating-794a) ([#1292](https://github.com/damien-robotsix/robotsix-chat/issues/1292)) ([601e35b](https://github.com/damien-robotsix/robotsix-chat/commit/601e35b6ca6e8a839bc1b15aacb07d7d0ac5a8e0))
* Assistant cannot explain how to configure autonomous sessions via settings panel (20260807T214959Z-assistant-cannot-explain-how-to-configur-78b0) ([#1289](https://github.com/damien-robotsix/robotsix-chat/issues/1289)) ([0f8fa7f](https://github.com/damien-robotsix/robotsix-chat/commit/0f8fa7f33d7969510e9c23af6cf31b461a281388))
* Auto-close superseded draft tickets (20260809T001107Z-auto-close-superseded-draft-tickets-4416) ([#1304](https://github.com/damien-robotsix/robotsix-chat/issues/1304)) ([c3711fc](https://github.com/damien-robotsix/robotsix-chat/commit/c3711fc857782f7d900032c312df5a1f09bd9cbc))
* Auto-trigger a continuation conversation after self-restart (20260810T073955Z-auto-trigger-a-continuation-conversation-563d) ([#1315](https://github.com/damien-robotsix/robotsix-chat/issues/1315)) ([7fed957](https://github.com/damien-robotsix/robotsix-chat/commit/7fed957087a6fbe735f1f07ae21520a346fc2854))
* Automate self-restart after capability-affecting deployments without user confirmation (20260808T181237Z-automate-self-restart-after-capability-a-3ab1) ([#1298](https://github.com/damien-robotsix/robotsix-chat/issues/1298)) ([41e3083](https://github.com/damien-robotsix/robotsix-chat/commit/41e30834db0e1411cad606f362779948aa22008b))
* Autonomous sessions should run as normal auto-started sessions that close on completion (20260809T144920Z-autonomous-sessions-should-run-as-normal-2694) ([#1400](https://github.com/damien-robotsix/robotsix-chat/issues/1400)) ([ad477ec](https://github.com/damien-robotsix/robotsix-chat/commit/ad477ec27d7748f5a0ef5726069473cee9a51c2e))
* Avoid duplicate ticket creation from concurrent monitors (20260807T230221Z-avoid-duplicate-ticket-creation-from-con-1495) ([#1291](https://github.com/damien-robotsix/robotsix-chat/issues/1291)) ([98a1281](https://github.com/damien-robotsix/robotsix-chat/commit/98a12814f37dc74b717ba85ffe683e158ad0575e))
* Consolidate subsession outcomes without redundant resumption of failed tickets (20260806T230334Z-consolidate-subsession-outcomes-without-a3e9) ([#1325](https://github.com/damien-robotsix/robotsix-chat/issues/1325)) ([e202334](https://github.com/damien-robotsix/robotsix-chat/commit/e20233409156929aa9bd640dfbecd90859c04685))
* Create subsession skill.md and wire it into _inject_skills (20260808T012405Z-create-subsession-skill-md-and-wire-it-i-893f) ([#1293](https://github.com/damien-robotsix/robotsix-chat/issues/1293)) ([c690694](https://github.com/damien-robotsix/robotsix-chat/commit/c69069487b9e69be69a7d698c95fc0b9b85a220f))
* Document OVH IMAP namespace issue for archive root configuration (20260810T214546Z-document-ovh-imap-namespace-issue-for-ar-0c11) ([#1403](https://github.com/damien-robotsix/robotsix-chat/issues/1403)) ([1788dda](https://github.com/damien-robotsix/robotsix-chat/commit/1788dda26e89cc71e10f7f65b64e28e2b5adbb60))
* Expose monitor auto-resume decisions to user (20260807T215530Z-expose-monitor-auto-resume-decisions-to-8e17) ([#1290](https://github.com/damien-robotsix/robotsix-chat/issues/1290)) ([b868b7d](https://github.com/damien-robotsix/robotsix-chat/commit/b868b7d08eb842b279687844f1ec75a6494ea901))
* Filed mill-improvement ticket never left draft state (20260811T083147Z-filed-mill-improvement-ticket-never-left-d32d) ([#1395](https://github.com/damien-robotsix/robotsix-chat/issues/1395)) ([4885a1c](https://github.com/damien-robotsix/robotsix-chat/commit/4885a1cba2ccf22d17b0269518ca87dd9f296d1a))
* Implement lazy creation of archive subfolders and clean up empties (20260809T082040Z-implement-lazy-creation-of-archive-subfo-d109) ([#1339](https://github.com/damien-robotsix/robotsix-chat/issues/1339)) ([457070f](https://github.com/damien-robotsix/robotsix-chat/commit/457070f347370a8169510b91de8c228bf7034582))
* Improve diagnosis of persistent git clone failures to differentiate transient vs. permission issues (20260806T230334Z-improve-diagnosis-of-persistent-git-clon-9b74) ([#1344](https://github.com/damien-robotsix/robotsix-chat/issues/1344)) ([196b534](https://github.com/damien-robotsix/robotsix-chat/commit/196b534b8e1ff82d5ad473560c4ab43e49f43f33))
* Incorporate UI design patterns when proposing layout changes (20260807T211641Z-incorporate-ui-design-patterns-when-prop-ef53) ([#1286](https://github.com/damien-robotsix/robotsix-chat/issues/1286)) ([809a297](https://github.com/damien-robotsix/robotsix-chat/commit/809a297bfc09b1a64fe8d75608f1c5dcd3855d68))
* Label/categorise chat-agent Langfuse traces by function for cost attribution (20260802T223709Z-label-categorise-chat-agent-langfuse-tra-aaa7) ([#1271](https://github.com/damien-robotsix/robotsix-chat/issues/1271)) ([2cfd4f1](https://github.com/damien-robotsix/robotsix-chat/commit/2cfd4f17a226fd7138095f64996b3d564193b881))
* Missing tool to list directory contents from volume mounts (20260809T092628Z-missing-tool-to-list-directory-contents-0b43) ([#1340](https://github.com/damien-robotsix/robotsix-chat/issues/1340)) ([acf6ca3](https://github.com/damien-robotsix/robotsix-chat/commit/acf6ca3bcd6ef384c48aee849d9db466f280a38e))
* per-session model escalation with a visible model badge ([#1341](https://github.com/damien-robotsix/robotsix-chat/issues/1341)) ([8011518](https://github.com/damien-robotsix/robotsix-chat/commit/8011518f4436351a76331376c787c6ab9d6df38c))
* Pre-deployment CI health check across fleet repos (20260808T211358Z-pre-deployment-ci-health-check-across-fl-7007) ([#1302](https://github.com/damien-robotsix/robotsix-chat/issues/1302)) ([5e9b604](https://github.com/damien-robotsix/robotsix-chat/commit/5e9b60417128de6dc8e756e085d1890d0792f90a))
* Provide a single consolidated outcome summary at session end (20260809T094616Z-provide-a-single-consolidated-outcome-su-1082) ([#1342](https://github.com/damien-robotsix/robotsix-chat/issues/1342)) ([35bed1b](https://github.com/damien-robotsix/robotsix-chat/commit/35bed1be231cac8351ad280a0af2e1b715183cd8))
* Reduce chat-agent Claude weekly-cap consumption: verify prompt caching + tier-rebalance (20260810T074522Z-reduce-chat-agent-claude-weekly-cap-cons-df0f) ([#1327](https://github.com/damien-robotsix/robotsix-chat/issues/1327)) ([f0b82bf](https://github.com/damien-robotsix/robotsix-chat/commit/f0b82bfe77827a60f88bb576c45d6cd87c7d528f))
* Remove vestigial plan_text field from autonomous_state_frame and chat.js (20260813T041131Z-remove-vestigial-plan-text-field-from-au-2f0a) ([#1426](https://github.com/damien-robotsix/robotsix-chat/issues/1426)) ([b8a9179](https://github.com/damien-robotsix/robotsix-chat/commit/b8a9179b932ef32345a4d194f7e4409ed2ad1e61))
* Runtime infra: route CI job-log fetch through a stable path instead of central-deploy DNS (20260802T214116Z-runtime-infra-route-ci-job-log-fetch-thr-b0e6) ([#1270](https://github.com/damien-robotsix/robotsix-chat/issues/1270)) ([03dbecc](https://github.com/damien-robotsix/robotsix-chat/commit/03dbecccb64350d7d4379b965a236ee8bdaebb16))
* Token-budget enforcement blocks tool calls mid-conversation with no recovery path (20260807T133351Z-token-budget-enforcement-blocks-tool-cal-e39b) ([#1391](https://github.com/damien-robotsix/robotsix-chat/issues/1391)) ([a4f8386](https://github.com/damien-robotsix/robotsix-chat/commit/a4f8386070b2190acc692a0023b681ce7fbf61c3))
* tool_error — The classifier flags 'tool_errors (2)' but no observations in the trace have level='ERROR' (20260807T205524Z-tool-error-the-classifier-flags-tool-err-39f8) ([#1285](https://github.com/damien-robotsix/robotsix-chat/issues/1285)) ([c201fbc](https://github.com/damien-robotsix/robotsix-chat/commit/c201fbcecffdcc0184b2509be52741fc07f22275))
* Track and surface the live state of a blocked ticket when the board API is unreachable (20260807T214931Z-track-and-surface-the-live-state-of-a-bl-e3dc) ([#1288](https://github.com/damien-robotsix/robotsix-chat/issues/1288)) ([7000591](https://github.com/damien-robotsix/robotsix-chat/commit/7000591c7e6203e8cea053eb7783816c7bccde8c))
* Wake paused periodic monitors on mill ticket state-change notification (20260809T145904Z-wake-paused-periodic-monitors-on-mill-ti-b94b) ([#1360](https://github.com/damien-robotsix/robotsix-chat/issues/1360)) ([6a465cd](https://github.com/damien-robotsix/robotsix-chat/commit/6a465cdc0418af34bc7a0dd8aa52df417fdcc0e2))
* When a user says 'the mill will rebase', stop reoffering manual rebase options (20260809T141619Z-when-a-user-says-the-mill-will-rebase-st-a78d) ([#1414](https://github.com/damien-robotsix/robotsix-chat/issues/1414)) ([f81e7fb](https://github.com/damien-robotsix/robotsix-chat/commit/f81e7fb71726230f01ce10ccb56e7ef4b2ce9581))


### Bug Fixes

* Add long-term health checks for feedback loops and memory (20260808T082011Z-add-long-term-health-checks-for-feedback-cd45) ([#1294](https://github.com/damien-robotsix/robotsix-chat/issues/1294)) ([e31ae24](https://github.com/damien-robotsix/robotsix-chat/commit/e31ae2449678143a864e94c3fa444d4de3e3340a))
* Add WARNING-level logging to all silent early-return paths in the diagnostic emitter (20260809T064346Z-add-warning-level-logging-to-all-silent-6e61) ([#1313](https://github.com/damien-robotsix/robotsix-chat/issues/1313)) ([b6edfec](https://github.com/damien-robotsix/robotsix-chat/commit/b6edfeca289dfaacc755b04e39db66f66c55bef4))
* Assistant failed to detect session resumption and repeated the exact same digest (20260811T081603Z-assistant-failed-to-detect-session-resum-f0fb) ([#1394](https://github.com/damien-robotsix/robotsix-chat/issues/1394)) ([6c152b6](https://github.com/damien-robotsix/robotsix-chat/commit/6c152b6a850113499fa4f76863d792e4f4bcb063))
* Assistant fails to consolidate multiple subsession outcomes into one reply (20260809T065402Z-assistant-fails-to-consolidate-multiple-20b5) ([#1334](https://github.com/damien-robotsix/robotsix-chat/issues/1334)) ([830ca36](https://github.com/damien-robotsix/robotsix-chat/commit/830ca36428b56d4bd14a6ae0ce2e9af92df871f9))
* Assistant hallucinated stale mailbox config before verifying it (20260811T081603Z-assistant-hallucinated-stale-mailbox-con-5ab0) ([#1412](https://github.com/damien-robotsix/robotsix-chat/issues/1412)) ([868a94f](https://github.com/damien-robotsix/robotsix-chat/commit/868a94fb1e9a47d9807badb10a0a6893873c3471))
* Autonomous session default preset not appearing due to explicit empty list in config (20260809T131842Z-autonomous-session-default-preset-not-ap-2c62) ([#1408](https://github.com/damien-robotsix/robotsix-chat/issues/1408)) ([7a3c4fe](https://github.com/damien-robotsix/robotsix-chat/commit/7a3c4fe7d4fdfeba9cbe614ca7bdaf70f29cbe6c))
* Avoid suggesting stale/disconnected monitors as actionable items (20260809T141620Z-avoid-suggesting-stale-disconnected-moni-7f5e) ([#1419](https://github.com/damien-robotsix/robotsix-chat/issues/1419)) ([5803bd3](https://github.com/damien-robotsix/robotsix-chat/commit/5803bd3b2ddeff714cd3bbeddc3dc0fe8283d96c))
* bind the SDK session with resume, not session_id ([#1434](https://github.com/damien-robotsix/robotsix-chat/issues/1434)) ([62c5373](https://github.com/damien-robotsix/robotsix-chat/commit/62c53738218367d358f62d61116d21b75166aced))
* Changelog version-numbering integrity: 7 duplicate versions, missing v23, out-of-order v70, unresolved v46 TODO (20260803T143904Z-changelog-version-numbering-integrity-7-e48f) ([#1279](https://github.com/damien-robotsix/robotsix-chat/issues/1279)) ([de1567c](https://github.com/damien-robotsix/robotsix-chat/commit/de1567c23007dc7d2abb74ba0f448b092868e681))
* CI failure: Release image on main (20260811T154719Z-ci-failure-release-image-on-main-a424) ([#1322](https://github.com/damien-robotsix/robotsix-chat/issues/1322)) ([4bfd76c](https://github.com/damien-robotsix/robotsix-chat/commit/4bfd76c4b625b1f67bf74b7340d6723a795bebfc))
* ci_fix: out-of-scope CI failure — Python CI (shared) / Tests — test_frozen_store_warning_not_spammy in src/robotsix_chat/memory/cognee.py::_record_write_failure (frozen-store alert rate-limit/reset epsilon) and/or tests/memory/test_memory.py (20260813T073759Z-ci-fix-out-of-scope-ci-failure-python-ci-5789) ([#1415](https://github.com/damien-robotsix/robotsix-chat/issues/1415)) ([3d16a0e](https://github.com/damien-robotsix/robotsix-chat/commit/3d16a0e644716212c3dd2aac0c84112b3ed5e0dd))
* Consolidate subsession outcomes into a single user-facing narrative (20260810T082645Z-consolidate-subsession-outcomes-into-a-s-de9a) ([#1375](https://github.com/damien-robotsix/robotsix-chat/issues/1375)) ([d841508](https://github.com/damien-robotsix/robotsix-chat/commit/d841508b706ab30e6e081811be888253a10afa3c))
* Convert docs/ticket-poll/skill.md to symlink (stale copy, 120 lines behind src/) (20260805T171633Z-convert-docs-ticket-poll-skill-md-to-sym-e4d7) ([#1283](https://github.com/damien-robotsix/robotsix-chat/issues/1283)) ([65a8bf2](https://github.com/damien-robotsix/robotsix-chat/commit/65a8bf207d159ded3d132b7c4a3531cddd916e41))
* Distinguish between 'no OPENROUTER_API_KEY' and 'key value not visible' in environment checks (20260803T075929Z-distinguish-between-no-openrouter-api-ke-5aa9) ([#1276](https://github.com/damien-robotsix/robotsix-chat/issues/1276)) ([26f3f83](https://github.com/damien-robotsix/robotsix-chat/commit/26f3f833571bfe95f41f26bef3d6c8ae3f9037e0))
* Enforce filtering of internal subsession identifiers from user-facing replies (20260809T065319Z-enforce-filtering-of-internal-subsession-3196) ([#1317](https://github.com/damien-robotsix/robotsix-chat/issues/1317)) ([28ec0d5](https://github.com/damien-robotsix/robotsix-chat/commit/28ec0d510b83937a682da4f4ff634e97fde17420))
* Ensure assistant suppresses internal subsession IDs and debug summaries in user-facing replies (20260809T062415Z-ensure-assistant-suppresses-internal-sub-3ce4) ([#1309](https://github.com/damien-robotsix/robotsix-chat/issues/1309)) ([8ab8f5e](https://github.com/damien-robotsix/robotsix-chat/commit/8ab8f5ec02d787087f7b6c2e446983eb2688a688))
* Event-driven monitors lose ticket ID on chat restart (20260809T222321Z-event-driven-monitors-lose-ticket-id-on-86bc) ([#1366](https://github.com/damien-robotsix/robotsix-chat/issues/1366)) ([c3a0daf](https://github.com/damien-robotsix/robotsix-chat/commit/c3a0daf2cca27c7c7afacb7f4d312187ac55ecbe))
* Event-driven monitors lose ticket_id across chat restarts (20260809T092628Z-event-driven-monitors-lose-ticket-id-acr-c24b) ([#1347](https://github.com/damien-robotsix/robotsix-chat/issues/1347)) ([508454a](https://github.com/damien-robotsix/robotsix-chat/commit/508454ab544d4b03e6d4bf2ca594ac5c5ba18ac8))
* Feedback analyzer misreads its own 'Subsession summaries:' prompt block as assistant output (12 false-positive tickets) (20260809T061049Z-feedback-analyzer-misreads-its-own-subse-6f73) ([#1308](https://github.com/damien-robotsix/robotsix-chat/issues/1308)) ([1fc1ad8](https://github.com/damien-robotsix/robotsix-chat/commit/1fc1ad877891d7dbfff3bec49ad69c4cd556c044))
* Fix contradictory no-change prompt in board-unchanged resume path (20260813T015502Z-fix-contradictory-no-change-prompt-in-bo-bc3d) ([#1425](https://github.com/damien-robotsix/robotsix-chat/issues/1425)) ([53b3571](https://github.com/damien-robotsix/robotsix-chat/commit/53b3571d4d1d8248cc13216d953602121b4d3adc))
* Fix false "token exhaustion" punts and retain ticket IDs/PR URLs in conversation summaries (20260803T103612Z-fix-false-token-exhaustion-punts-and-ret-b73c) ([#1277](https://github.com/damien-robotsix/robotsix-chat/issues/1277)) ([d5dc7bf](https://github.com/damien-robotsix/robotsix-chat/commit/d5dc7bf335c81ec3020ad9097657a857df670381))
* Fix monitor spawn race condition: ticket ID missing from checkpoint (20260809T190524Z-fix-monitor-spawn-race-condition-ticket-ef5f) ([#1361](https://github.com/damien-robotsix/robotsix-chat/issues/1361)) ([5c0075b](https://github.com/damien-robotsix/robotsix-chat/commit/5c0075bd32c2f72adac5d9aa99461d0863e24126))
* Fix periodic subsession auto-resume logic (20260808T185946Z-fix-periodic-subsession-auto-resume-logi-d6b0) ([#1299](https://github.com/damien-robotsix/robotsix-chat/issues/1299)) ([329b154](https://github.com/damien-robotsix/robotsix-chat/commit/329b154db3ea279c40bd64b8a9dec9194dc70307))
* Fix roster-fallback error detection in mark_ticket_ready so real HTTP errors trigger direct path (20260813T020838Z-fix-roster-fallback-error-detection-in-m-147a) ([#1427](https://github.com/damien-robotsix/robotsix-chat/issues/1427)) ([2b3ec2d](https://github.com/damien-robotsix/robotsix-chat/commit/2b3ec2d391c75e90c3dd3227c524fea09761f5b3))
* Fix stale/incorrect diagnosis of Langfuse access issue (20260809T092600Z-fix-stale-incorrect-diagnosis-of-langfus-3000) ([#1346](https://github.com/damien-robotsix/robotsix-chat/issues/1346)) ([66df09c](https://github.com/damien-robotsix/robotsix-chat/commit/66df09cfa5283e2fae7bf82b5fd82d5e0f34474b))
* Fix wait_for_event subsession checkpoint not persisting ticket_id (20260809T065401Z-fix-wait-for-event-subsession-checkpoint-871a) ([#1333](https://github.com/damien-robotsix/robotsix-chat/issues/1333)) ([0630722](https://github.com/damien-robotsix/robotsix-chat/commit/0630722d92178013aec26e5f254cea81a5ce5cad))
* Generate structured plans and confirm user intent before large dumps (20260810T162820Z-generate-structured-plans-and-confirm-us-4e14) ([#1389](https://github.com/damien-robotsix/robotsix-chat/issues/1389)) ([a2a5f27](https://github.com/damien-robotsix/robotsix-chat/commit/a2a5f2734d2b7f92ff5b20b0f073add7cd4284c9))
* Global subsession pool capacity limit (20) blocks monitor spawning (20260809T065402Z-global-subsession-pool-capacity-limit-20-cbfc) ([#1335](https://github.com/damien-robotsix/robotsix-chat/issues/1335)) ([9e697ef](https://github.com/damien-robotsix/robotsix-chat/commit/9e697ef307df014fb277d903a963939f81a9c3fb))
* Implement agent fails to parse List-Unsubscribe header and ticket becomes blocked (20260807T122159Z-implement-agent-fails-to-parse-list-unsu-9153) ([#1405](https://github.com/damien-robotsix/robotsix-chat/issues/1405)) ([3587365](https://github.com/damien-robotsix/robotsix-chat/commit/35873650c04f69d854f8e423588c0b7a713e357c))
* Monitor respawn on session restart is missing for in-flight tickets (20260810T080401Z-monitor-respawn-on-session-restart-is-mi-50f4) ([#1372](https://github.com/damien-robotsix/robotsix-chat/issues/1372)) ([24bf3df](https://github.com/damien-robotsix/robotsix-chat/commit/24bf3dfe5678bd85b535d624e45babcf8b062c1e))
* Monitor should not declare ticket deleted based on API unreachability (20260811T185247Z-monitor-should-not-declare-ticket-delete-08d0) ([#1424](https://github.com/damien-robotsix/robotsix-chat/issues/1424)) ([f06ce18](https://github.com/damien-robotsix/robotsix-chat/commit/f06ce18eacc8476ac2fd947291abfe24221bcbc0))
* Periodic monitor auto-pauses without surfacing actionable status to user (20260811T083146Z-periodic-monitor-auto-pauses-without-sur-a2a9) ([#1393](https://github.com/damien-robotsix/robotsix-chat/issues/1393)) ([bf37da3](https://github.com/damien-robotsix/robotsix-chat/commit/bf37da3207e2d4b7836c204cf49e7866ee4d86cf))
* Prevent duplicate ticket creation from overlapping subsessions (20260809T100702Z-prevent-duplicate-ticket-creation-from-o-f900) ([#1349](https://github.com/damien-robotsix/robotsix-chat/issues/1349)) ([05a1e80](https://github.com/damien-robotsix/robotsix-chat/commit/05a1e80e281e4f0d173ae6b9e862dd64d860c825))
* Prevent periodic monitors from auto-pausing on long waits; use event-driven resumption (20260809T100703Z-prevent-periodic-monitors-from-auto-paus-95d3) ([#1350](https://github.com/damien-robotsix/robotsix-chat/issues/1350)) ([cea287c](https://github.com/damien-robotsix/robotsix-chat/commit/cea287c13490e482b774cf36ecdd89a917c618f9))
* Replace fragile inline kind→endpoint dispatch in ComponentAgentClient._post with explicit mapping (20260806T183631Z-replace-fragile-inline-kind-endpoint-dis-2cd0) ([#1324](https://github.com/damien-robotsix/robotsix-chat/issues/1324)) ([961717f](https://github.com/damien-robotsix/robotsix-chat/commit/961717f3376842ad78772bb627bdc6b1f8a13865))
* Review auto-compaction strategy: preserve operator-confirmed plans and pending actions (20260810T163157Z-review-auto-compaction-strategy-preserve-b60a) ([#1402](https://github.com/damien-robotsix/robotsix-chat/issues/1402)) ([ba1092d](https://github.com/damien-robotsix/robotsix-chat/commit/ba1092d215f8aa0e0ec0c6a51a34bbb25bfd7977))
* Strip raw subsession metadata from user-facing replies (20260809T100626Z-strip-raw-subsession-metadata-from-user-979e) ([#1348](https://github.com/damien-robotsix/robotsix-chat/issues/1348)) ([057f458](https://github.com/damien-robotsix/robotsix-chat/commit/057f458a8c7fb441be8222f4ccc6ed6bf25ec912))
* valid UUID for Claude SDK session id; revert level-4 tier rebalance ([#1329](https://github.com/damien-robotsix/robotsix-chat/issues/1329)) ([5ea3db4](https://github.com/damien-robotsix/robotsix-chat/commit/5ea3db4c0f06e8cf41165e67165a0411aba259dc))
* Verify ticket persistence immediately after ingest (20260802T214114Z-verify-ticket-persistence-immediately-af-bce4) ([#1268](https://github.com/damien-robotsix/robotsix-chat/issues/1268)) ([18720bb](https://github.com/damien-robotsix/robotsix-chat/commit/18720bb6388436e409b5d32b2ba568857cf70702))


### Documentation

* Add ### Health settings reference section for HealthSettings model (20260811T000905Z-docs-add-health-settings-reference-secti-b8fa) ([#1411](https://github.com/damien-robotsix/robotsix-chat/issues/1411)) ([baa8cad](https://github.com/damien-robotsix/robotsix-chat/commit/baa8cad985cd557733c0197d5f5f8112f1c9d746))
* Add missing ### Docker Digest section to docs/configuration.md for DockerDigestSettings (20260802T160820Z-add-missing-docker-digest-section-to-doc-0608) ([#1321](https://github.com/damien-robotsix/robotsix-chat/issues/1321)) ([ef5792f](https://github.com/damien-robotsix/robotsix-chat/commit/ef5792f878628eb4fe762eeaa76dc633785ac425))
* AGENT.md: Prompt engineering conventions — **Rule:** When constructing prompts that include a "stop", "no-op", or "NO_CHAN… (20260813T015503Z-agent-md-prompt-engineering-conventions-7f0b) ([#1432](https://github.com/damien-robotsix/robotsix-chat/issues/1432)) ([ceb6713](https://github.com/damien-robotsix/robotsix-chat/commit/ceb67132f505ec80a36532f9b11aa2df5593c6d5))
* Always verify packaging compliance against live robotsix-standards before claiming fleet-wide consistency (20260802T210925Z-always-verify-packaging-compliance-again-43cf) ([#1323](https://github.com/damien-robotsix/robotsix-chat/issues/1323)) ([594fed8](https://github.com/damien-robotsix/robotsix-chat/commit/594fed82685582210f648654c740ba989837fee4))
* completeness_check scan: 4 findings (2026-08-07) (20260807T055217Z-completeness-check-scan-4-findings-2026-38a0) ([#1337](https://github.com/damien-robotsix/robotsix-chat/issues/1337)) ([8721a6b](https://github.com/damien-robotsix/robotsix-chat/commit/8721a6bdc98dab10e776f023c0e5d6a10e5702c3))
* Improve feature request guidance to include edge-case handling and feedback requirements (20260809T214510Z-improve-feature-request-guidance-to-incl-dbd9) ([#1363](https://github.com/damien-robotsix/robotsix-chat/issues/1363)) ([67b6352](https://github.com/damien-robotsix/robotsix-chat/commit/67b63526f95313224ab7250e0c85aa7b335a8d76))
* Self-config write path should be documented and consistent (20260810T082149Z-self-config-write-path-should-be-documen-3467) ([#1371](https://github.com/damien-robotsix/robotsix-chat/issues/1371)) ([b298800](https://github.com/damien-robotsix/robotsix-chat/commit/b298800a9131025ac2986e488c1825673c2226c7))
* Self-config write path unclear: assistant initially used wrong endpoint (20260809T131843Z-self-config-write-path-unclear-assistant-a801) ([#1413](https://github.com/damien-robotsix/robotsix-chat/issues/1413)) ([d612a4b](https://github.com/damien-robotsix/robotsix-chat/commit/d612a4b563cfb608e87a20ba415e3ca1d9fbde68))
...
- Bound how many memory recalls run inside cognee at once (new
  ...
  timeout, so a backlog still degrades to "no memory" on schedule. ([#bound-recall-concurrency](https://github.com/damien-robotsix/robotsix-chat/issues/bound-recall-concurrency))
- Bumped robotsix-llmio past the `task_budget` fixes. The pinned build clamped a
  ...
  and a model that rejects the parameter is retried without it. ([#bump-llmio-task-budget](https://github.com/damien-robotsix/robotsix-chat/issues/bump-llmio-task-budget))
- The feedback runner's repo-roster lookup now uses the configured
  ...
  but a log line to show for it. ([#feedback-deploy-base-url](https://github.com/damien-robotsix/robotsix-chat/issues/feedback-deploy-base-url))
- Disable cognee 1.4's session memory (`CACHING=false`): chat never reads the
  ...
  grew un-checkpointable (626 MB observed) on the shared-HDD deploy host (#1201). ([#memory-disable-cognee-session-cache](https://github.com/damien-robotsix/robotsix-chat/issues/memory-disable-cognee-session-cache))
- Share one cognee memory backend across all agents and make its setup
  ...
  loop during warm-up. ([#memory-shared-backend-cancellation-safe-setup](https://github.com/damien-robotsix/robotsix-chat/issues/memory-shared-backend-cancellation-safe-setup))
- Bumped `pypdf` to 6.15.0, closing GHSA-fp3f-mc75-235c and GHSA-fwg2-594c-jp42
  (both resource exhaustion). The advisories landed against the pinned version, so
  CI started failing on their own — the same fresh advisory that reddened mill. ([#pypdf-advisories](https://github.com/damien-robotsix/robotsix-chat/issues/pypdf-advisories))
- Make the recall concurrency bound process-wide instead of per-instance. The
  ...
  introduced alongside `recall_max_concurrency` really admitted 6x its limit. ([#recall-gate-process-global](https://github.com/damien-robotsix/robotsix-chat/issues/recall-gate-process-global))
- Serve the same session list from every access point. The UI minted a random
  ...
  keep their own pool and are still listed separately. ([#single-user-session-pool](https://github.com/damien-robotsix/robotsix-chat/issues/single-user-session-pool))
- Pay cognee's cold-start cost in a background task at server startup instead of
  ...
  deadline on its own even after setup had completed. ([#warm-cognee-at-startup](https://github.com/damien-robotsix/robotsix-chat/issues/warm-cognee-at-startup))
- Fix system prompt and guardrail docs referencing the non-existent ``merge_pr`` tool — both now correctly reference ``merge_direct_repo_pr``, the exported agent tool name. ([#20260801T100719Z-fix-merge-capability-doc-references-to-u-39ff](https://github.com/damien-robotsix/robotsix-chat/issues/20260801T100719Z-fix-merge-capability-doc-references-to-u-39ff))
- Reverted the release-automation bootstrap added to `create_repo` earlier today. It provisioned the towncrier `auto-release.yml`, a **superseded** convention — `changelog-driven-releases.md` is superseded by `release-please.md`, the fleet-wide release automation. Every new `robotsix-` repo would have been born with the wrong mechanism. ([#20260808T120800Z-revert-bootstrap-superseded](https://github.com/damien-robotsix/robotsix-chat/issues/20260808T120800Z-revert-bootstrap-superseded))
- Changed auto-pause notice for periodic subsessions to no longer promise automatic resume. The notice now directs the parent agent to resume via `message_subsession`, and any inbox message (including parent messages) now wakes a paused monitor so the documented resume path actually works. ([#20260807T133107Z-paused-periodic-subsessions-never-auto-r-b583](https://github.com/damien-robotsix/robotsix-chat/issues/20260807T133107Z-paused-periodic-subsessions-never-auto-r-b583))
- Include the `github-actions` extra (PyNaCl) in the container image so the `set_actions_secret` tool can encrypt repository secrets at runtime instead of returning a "PyNaCl is required" error. ([#20260807T174826Z-set-actions-secret-fails-pynacl-missing-682f](https://github.com/damien-robotsix/robotsix-chat/issues/20260807T174826Z-set-actions-secret-fails-pynacl-missing-682f))
- `ticket_poll` now surfaces the real board-API failure instead of a generic "Board API request failed": a 404 says the ticket does not exist (likely a paraphrased/stale ID, with a hint to list tickets), and HTTP errors, timeouts, connection failures, and non-JSON bodies each carry their own reason. ([#20260806T175629Z-ticket-poll-launders-http-404-into-gener-ecce](https://github.com/damien-robotsix/robotsix-chat/issues/20260806T175629Z-ticket-poll-launders-http-404-into-gener-ecce))
- Fix subsession registry self-match dedup bug: when a periodic monitor with `dedup_key == checkpoint.ticket_id` was resumed after a container restart, `create()` would insert the entry first, then `find_active_periodic_by_ticket_id` would match the newly-inserted entry itself — raising `SubsessionDedupError` and leaving a RUNNING zombie with no worker task. Dedup checks now run before insertion. ([#20260807T200131Z-subsession-dedup-self-match-on-resume-le-e052](https://github.com/damien-robotsix/robotsix-chat/issues/20260807T200131Z-subsession-dedup-self-match-on-resume-le-e052))
- Fix intermittent `wait_for_event` subsession startup failure where the event-wait loop closed the monitor with `missing_ticket_id` because the checkpoint had not yet recorded the ticket id. The ticket id is now pre-populated into the checkpoint at spawn time (structured parameter) and the event-wait loop falls back to `dedup_key` as a safety net. ([#20260808T200808Z-wait-for-event-subsession-dies-at-startu-be85](https://github.com/damien-robotsix/robotsix-chat/issues/20260808T200808Z-wait-for-event-subsession-dies-at-startu-be85))
- `PUT /config` no longer widens the config file's permissions. The atomic write renames a fresh temp file over the target, so a `0600` config — which holds API keys and other secrets — came back world-readable at the process umask after every save. The replacement now carries the original file's mode, falling back to owner-only when there is no existing file to copy from. ([#20260808T211500Z-config-write-preserves-file-mode](https://github.com/damien-robotsix/robotsix-chat/issues/20260808T211500Z-config-write-preserves-file-mode))
...
- Removed the one-time config import from central-deploy: the `POST /config/import`
  ...
  depends on. ([#drop-config-import](https://github.com/damien-robotsix/robotsix-chat/issues/drop-config-import))
- Removed lifecycle config-store tools (`get_lifecycle_service_config`, `update_lifecycle_service_config`, `watch_service_redeploy`) and their client methods from the deploy-lifecycle integration. Components now own their configuration internally via `/config` endpoints; the central-deploy config-store API is no longer used at runtime. Deploy-boundary config (volume mounts, port mappings, image refs, boot-time secrets) is unchanged. ([#20260801T085118Z-config-ownership-migration-robotsix-chat-f7dd](https://github.com/damien-robotsix/robotsix-chat/issues/20260801T085118Z-config-ownership-migration-robotsix-chat-f7dd))
- `fleet_auth` is now a single top-level setting. It was declared three times — under `http_probe`, `render_url` and `public_fetch` — as three copies of the same `FleetAuthSettings`, so the one fleet reverse-proxy credential had to be entered in three places and three copies of `auth_hosts` kept in sync. The per-tool fields are removed outright, with no deprecation shim: move any values you have set to the top-level `fleet_auth`. This also matches what central-deploy already writes when it reconciles `fleet_auth.auth_hosts`, which previously produced a config chat rejected at boot. ([#20260808T223000Z-single-fleet-auth-setting](https://github.com/damien-robotsix/robotsix-chat/issues/20260808T223000Z-single-fleet-auth-setting))

### Misc

- [#20260807T003651Z-cut-chat-agent-claude-weekly-cap-consump-0084](https://github.com/damien-robotsix/robotsix-chat/issues/20260807T003651Z-cut-chat-agent-claude-weekly-cap-consump-0084), [#20260804T004152Z-extend-system-prompt-governance-to-the-a-e556](https://github.com/damien-robotsix/robotsix-chat/issues/20260804T004152Z-extend-system-prompt-governance-to-the-a-e556), [#20260803T004312Z-remove-re-introduced-duplicate-tests-rep-4a63](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T004312Z-remove-re-introduced-duplicate-tests-rep-4a63), [#20260727T010417Z-add-post-deploy-defacement-detection-ass-e6f0](https://github.com/damien-robotsix/robotsix-chat/issues/20260727T010417Z-add-post-deploy-defacement-detection-ass-e6f0), [#20260802T012754Z-settings-ui-add-an-editor-for-autonomous-7cb5](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T012754Z-settings-ui-add-an-editor-for-autonomous-7cb5), [#20260801T052237Z-http-probe-fleet-auth-missing-from-http-bef1](https://github.com/damien-robotsix/robotsix-chat/issues/20260801T052237Z-http-probe-fleet-auth-missing-from-http-bef1), [#20260801T052237Z-subsessions-user-chat-max-retries-missin-256f](https://github.com/damien-robotsix/robotsix-chat/issues/20260801T052237Z-subsessions-user-chat-max-retries-missin-256f), [#20260803T052441Z-stale-github-token-rows-in-version-check-e8c5](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T052441Z-stale-github-token-rows-in-version-check-e8c5), [#20260805T053606Z-remove-dead-conversationstore-get-compac-fd44](https://github.com/damien-robotsix/robotsix-chat/issues/20260805T053606Z-remove-dead-conversationstore-get-compac-fd44), [#20260803T092301Z-clarify-autonomous-merge-criteria-in-ass-93b9](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T092301Z-clarify-autonomous-merge-criteria-in-ass-93b9), [#20260803T092302Z-improve-visibility-into-ci-job-failures-8192](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T092302Z-improve-visibility-into-ci-job-failures-8192), [#20260803T092622Z-add-a-tool-to-fetch-github-actions-job-l-0b6f](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T092622Z-add-a-tool-to-fetch-github-actions-job-l-0b6f), [#20260805T103350Z-fix-malformed-base-url-in-list-lifecycle-0b03](https://github.com/damien-robotsix/robotsix-chat/issues/20260805T103350Z-fix-malformed-base-url-in-list-lifecycle-0b03), [#20260805T103640Z-fix-false-token-exhaustion-self-punts-4abc](https://github.com/damien-robotsix/robotsix-chat/issues/20260805T103640Z-fix-false-token-exhaustion-self-punts-4abc), [#20260805T105006Z-add-github-api-fallback-for-ci-diagnosti-1310](https://github.com/damien-robotsix/robotsix-chat/issues/20260805T105006Z-add-github-api-fallback-for-ci-diagnosti-1310), [#20260801T110134Z-consolidate-duplicated-ticket-state-term-a338](https://github.com/damien-robotsix/robotsix-chat/issues/20260801T110134Z-consolidate-duplicated-ticket-state-term-a338), [#20260807T124333Z-ci-fix-out-of-scope-ci-failure-security-e5e0](https://github.com/damien-robotsix/robotsix-chat/issues/20260807T124333Z-ci-fix-out-of-scope-ci-failure-security-e5e0), [#20260802T135132Z-assistant-should-consult-notes-before-gu-e792](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T135132Z-assistant-should-consult-notes-before-gu-e792), [#20260802T135133Z-assistant-should-verify-associated-ticke-71d8](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T135133Z-assistant-should-verify-associated-ticke-71d8), [#20260802T135134Z-monitor-subsession-summary-for-approval-ed5c](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T135134Z-monitor-subsession-summary-for-approval-ed5c), [#20260801T151631Z-periodic-subsessions-cannot-spawn-parall-d04b](https://github.com/damien-robotsix/robotsix-chat/issues/20260801T151631Z-periodic-subsessions-cannot-spawn-parall-d04b), [#20260807T152356Z-robotsix-chat-enable-data-dir-gc-periodi-5961](https://github.com/damien-robotsix/robotsix-chat/issues/20260807T152356Z-robotsix-chat-enable-data-dir-gc-periodi-5961), [#20260731T154903Z-allow-a-periodic-subsession-to-self-upda-f04c](https://github.com/damien-robotsix/robotsix-chat/issues/20260731T154903Z-allow-a-periodic-subsession-to-self-upda-f04c), [#20260802T160820Z-add-test-coverage-for-src-robotsix-chat-9b93](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T160820Z-add-test-coverage-for-src-robotsix-chat-9b93), [#20260805T161635Z-repo-direct-client-py-remove-stale-depre-2d16](https://github.com/damien-robotsix/robotsix-chat/issues/20260805T161635Z-repo-direct-client-py-remove-stale-depre-2d16), [#20260802T163123Z-add-a-vitest-jsdom-unit-test-harness-for-f005](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T163123Z-add-a-vitest-jsdom-unit-test-harness-for-f005), [#20260804T165643Z-deduplicate-http-probe-and-public-fetch-fb2b](https://github.com/damien-robotsix/robotsix-chat/issues/20260804T165643Z-deduplicate-http-probe-and-public-fetch-fb2b), [#20260804T165644Z-add-dedicated-unit-test-coverage-for-src-7e00](https://github.com/damien-robotsix/robotsix-chat/issues/20260804T165644Z-add-dedicated-unit-test-coverage-for-src-7e00), [#20260804T165644Z-add-missing-component-credentials-docs-t-7760](https://github.com/damien-robotsix/robotsix-chat/issues/20260804T165644Z-add-missing-component-credentials-docs-t-7760), [#20260804T165644Z-extract-shared-scaffolding-from-5-check-50c8](https://github.com/damien-robotsix/robotsix-chat/issues/20260804T165644Z-extract-shared-scaffolding-from-5-check-50c8), [#20260802T165645Z-investigate-recurring-ci-quality-job-fai-00c1](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T165645Z-investigate-recurring-ci-quality-job-fai-00c1), [#20260803T171446Z-reorganize-module-repo-actions-align-to-47ac](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T171446Z-reorganize-module-repo-actions-align-to-47ac), [#20260806T171843Z-improve-detection-and-reporting-of-git-c-5719](https://github.com/damien-robotsix/robotsix-chat/issues/20260806T171843Z-improve-detection-and-reporting-of-git-c-5719), [#20260806T171845Z-reduce-confirmation-gates-on-low-risk-ac-33ad](https://github.com/damien-robotsix/robotsix-chat/issues/20260806T171845Z-reduce-confirmation-gates-on-low-risk-ac-33ad), [#20260803T173623Z-ci-failure-ci-on-main-14bd](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T173623Z-ci-failure-ci-on-main-14bd), [#20260803T173624Z-ci-failure-release-image-on-main-8a98](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T173624Z-ci-failure-release-image-on-main-8a98), [#20260802T184736Z-implement-true-pause-resume-for-periodic-f92d](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T184736Z-implement-true-pause-resume-for-periodic-f92d), [#20260802T200201Z-robotsix-chat-enable-credit-balance-peri-e594](https://github.com/damien-robotsix/robotsix-chat/issues/20260802T200201Z-robotsix-chat-enable-credit-balance-peri-e594), [#20260731T200829Z-investigate-and-fix-mill-closing-tickets-5f69](https://github.com/damien-robotsix/robotsix-chat/issues/20260731T200829Z-investigate-and-fix-mill-closing-tickets-5f69), [#20260731T200830Z-add-pre-merge-ci-gating-to-prevent-surfa-8281](https://github.com/damien-robotsix/robotsix-chat/issues/20260731T200830Z-add-pre-merge-ci-gating-to-prevent-surfa-8281), [#20260731T200903Z-add-unit-tests-for-the-failing-ci-resume-f2ce](https://github.com/damien-robotsix/robotsix-chat/issues/20260731T200903Z-add-unit-tests-for-the-failing-ci-resume-f2ce), [#20260808T213853Z-reduce-cognee-llm-cost-15-week-cut-outpu-8fdb](https://github.com/damien-robotsix/robotsix-chat/issues/20260808T213853Z-reduce-cognee-llm-cost-15-week-cut-outpu-8fdb), [#20260803T215339Z-ci-fix-out-of-scope-ci-failure-uv-audit-554f](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T215339Z-ci-fix-out-of-scope-ci-failure-uv-audit-554f), [#20260803T221224Z-fix-mypy-errors-causing-ci-quality-pre-c-6568](https://github.com/damien-robotsix/robotsix-chat/issues/20260803T221224Z-fix-mypy-errors-causing-ci-quality-pre-c-6568), [#20260731T235351Z-investigate-and-fix-systemic-ticket-clos-cc6f](https://github.com/damien-robotsix/robotsix-chat/issues/20260731T235351Z-investigate-and-fix-systemic-ticket-clos-cc6f)
...
- Fix transient uv sync segfault in CI by adding `--preview-features malware-check` flag alongside `UV_MALWARE_CHECK: "1"` in all CI jobs that use the malware check.
...
- **JS unit test harness (vitest + jsdom).** Added a frontend JavaScript test toolchain with vitest and jsdom to `package.json` (`npm run test:js`). Extracted the SSE stream parser, reconnect dedup guard, and message-queue into testable ES modules under `src/robotsix_chat/ui/static/`. Wired the SSE parser into `chat.js` (loaded as `<script type="module">`). Added 41 unit tests covering SSE parsing across chunk boundaries, line-ending normalisation, generation-stamp reconnect dedup, and FIFO queue busy-state gating. Wired a `frontend-js` CI job that gates on `npm ci && npm run test:js`.
...
- Extract the duplicated scaffolding from the five CI consistency-check scripts (`check_sse_event_types.py`, `check_subsession_kinds.py`, `check_subsession_statuses.py`, `check_activity_kinds.py`, `check_autonomous_states.py`) into a shared `scripts/_check_common.py` helper module. Each script now retains only its specific regexes, file paths, and label strings.
...
- Added `low_risk_actions` configuration option: a list of action names or
  ...
  low-risk heuristics).
- Removed stale "Deprecated wrapper methods remain on this class" sentence from `DirectRepoClient` module docstring — the 14 referenced methods were already removed. (mill: Fix false token-exhaustion self-punts (20260805T103640Z-fix-false-token-exhaustion-self-punts-4abc))
- **GitHub Actions — fallback log retrieval.** When ``fetch_workflow_run_annotations`` encounters a permission error (403) on the check-runs API, it now falls back to fetching raw job logs via a separate endpoint. A new ``fetch_job_log`` agent tool is also available for direct log retrieval. When all paths are inaccessible, the response includes a clear limitation notice and a link to the GitHub Actions UI for manual log inspection.
...
- Settings UI: add a presets editor for `autonomous.sessions`, allowing operators to view, create, edit, and delete autonomous-subsession presets directly from the Settings dialog without manual config-file edits. (mill: Settings UI: add an editor for autonomous-subsession presets (20260802T012754Z-settings-ui-add-an-editor-for-autonomous-7cb5))
...
- Document `http_probe.fleet_auth` config key and its nested `FleetAuthSettings` sub-fields in the HTTP Probe section of `docs/configuration.md`, mirroring the existing `public_fetch.fleet_auth` documentation pattern.
...
- Document `subsessions.user_chat_max_retries` in the Subsessions configuration table.
