...
- Removed stale `.gitmodules` file referencing the deleted `broker_src` submodule, and updated a leftover Dockerfile comment that mentioned the removed broker extra.
