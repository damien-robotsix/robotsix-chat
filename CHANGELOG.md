...
- Replace `pip-audit` pre-commit hook with native `uv audit` — reads `uv.lock` directly and additionally reports adverse package statuses (deprecated/archived/quarantined per PEP 792).
